...
* [pandas](https://pandas.pydata.org) - `Python` - pandas is an open source, BSD-licensed library providing high-performance, easy-to-use data structures and data analysis tools for the Python programming language. [GitHub](https://github.com/pandas-dev/pandas) ⭐ 49,826 | 🐛 2,570 | 🌐 Python | 📅 2026-09-25
* [polars](https://docs.pola.rs/) - `Python` - Polars is a blazingly fast DataFrame library for manipulating structured data. [GitHub](https://github.com/pola-rs/polars) ⭐ 39,867 | 🐛 2,931 | 🌐 Rust | 📅 2026-09-26
* [numpy](https://numpy.org/) - `Python` - NumPy is the fundamental package for scientific computing with Python. [GitHub](https://github.com/numpy/numpy) ⭐ 32,845 | 🐛 2,262 | 🌐 Python | 📅 2026-09-25
* [scipy](https://scipy.org/) - `Python` - SciPy (pronounced “Sigh Pie”) is a Python-based ecosystem of open-source software for mathematics, science, and engineering. [GitHub](https://github.com/scipy/scipy) ⭐ 15,046 | 🐛 1,847 | 🌐 Python | 📅 2026-09-26
* [sympy](https://www.sympy.org/) - `Python` - SymPy is a Python library for symbolic mathematics. [GitHub](https://github.com/sympy/sympy) ⭐ 14,969 | 🐛 6,018 | 🌐 Python | 📅 2026-09-26
* [pymc3](https://docs.pymc.io/) - `Python` - Probabilistic Programming in Python: Bayesian Modeling and Probabilistic Machine Learning with Theano. [GitHub](https://github.com/pymc-devs/pymc) ⭐ 9,776 | 🐛 516 | 🌐 Python | 📅 2026-09-21
* [data.table](https://github.com/Rdatatable/data.table) ⭐ 3,920 | 🐛 984 | 🌐 R | 📅 2026-09-23 - `R` - Extension of data.frame: Fast aggregation of large data (e.g. 100GB in RAM), fast ordered joins, fast add/modify/delete of columns by group using no copies at all, list columns and a fast file reader (fread). Offers a natural and flexible syntax, for faster development.
* [ArcticDB](https://github.com/man-group/ArcticDB) ⭐ 2,523 | 🐛 356 | 🌐 C++ | 📅 2026-09-26 - `Python` - High performance datastore for time series and tick data.
* [DataFrames.jl](https://github.com/JuliaData/DataFrames.jl) ⭐ 1,833 | 🐛 160 | 🌐 Julia | 📅 2026-09-17 - `Julia` - In-memory tabular data in Julia.
...
* [jacobian](https://github.com/morluto/jacobian) ⭐ 194 | 🐛 317 | 🌐 Python | 📅 2026-09-26 - `Python` `MCP` - Exact computation and conjecture testing across polynomial maps, linear algebra, and graph algorithms for agent-driven mathematical research.
...
* [gs-quant](https://github.com/goldmansachs/gs-quant) ⭐ 13,013 | 🐛 73 | 🌐 Python | 📅 2026-09-22 - `Python` - Python toolkit for quantitative finance.
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,510 | 🐛 42 | 🌐 Python | 📅 2026-08-06 - `Python` - High-performance TensorFlow library for quantitative finance.
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 3,163 | 🐛 50 | 🌐 Python | 📅 2026-09-25 - `Python` - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
* [ffn](https://github.com/pmorissette/ffn) ⭐ 2,679 | 🐛 8 | 🌐 Python | 📅 2026-09-25 - `Python` - A financial function library for Python.
* [RustQuant](https://github.com/avhz/RustQuant) ⭐ 1,821 | 🐛 31 | 🌐 Rust | 📅 2026-09-12 - `Rust` - Quantitative finance library written in Rust.
...
* [PyQL](https://github.com/enthought/pyql) ⭐ 1,339 | 🐛 20 | 🌐 Cython | 📅 2026-07-17 - `Python` - QuantLib's Python port.
...
* [QuantPy](https://github.com/jsmidt/QuantPy) ⭐ 1,059 | 🐛 17 | 🌐 Python | 📅 2023-05-25 - `Python` - A framework for quantitative finance In python.
* [vollib](https://github.com/vollib/vollib) ⭐ 1,022 | 🐛 4 | 🌐 Python | 📅 2023-06-05 - `Python` - vollib is a python library for calculating option prices, implied volatility and greeks.
* [Strata](https://strata.opengamma.io/) - `Java` - Modern open-source analytics and market risk library designed and written in Java. [GitHub](https://github.com/OpenGamma/Strata) ⭐ 965 | 🐛 92 | 🌐 Java | 📅 2026-09-23
* [Finance-Python](https://github.com/alpha-miner/Finance-Python) ⭐ 913 | 🐛 9 | 🌐 Python | 📅 2024-01-01 - `Python` - Python tools for Finance.
* [quantmod](https://cran.r-project.org/web/packages/quantmod/index.html) - `R` - Quantitative Financial Modelling Framework. [GitHub](https://github.com/joshuaulrich/quantmod) ⭐ 908 | 🐛 88 | 🌐 R | 📅 2026-07-03
* [Q-Fin](https://github.com/RomanMichaelPaolucci/Q-Fin) ⭐ 663 | 🐛 1 | 🌐 Python | 📅 2023-10-31 - `Python` - A Python library for mathematical finance.
* [Quantsbin](https://github.com/quantsbin/Quantsbin) ⭐ 650 | 🐛 3 | 🌐 Python | 📅 2023-07-06 - `Python` - Tools for pricing and plotting of vanilla option prices, greeks and various other analysis around them.
* [pysabr](https://github.com/ynouri/pysabr) ⭐ 624 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2022-04-21 - `Python` - SABR model Python implementation.
* [finmath.net](https://www.finmath.net/) - `Java` - Java library with algorithms and methodologies related to mathematical finance. [GitHub](https://github.com/finmath/finmath-lib) ⭐ 583 | 🐛 8 | 🌐 Java | 📅 2026-08-29
* [optionlab](https://github.com/rgaveiga/optionlab) ⭐ 571 | 🐛 6 | 🌐 Python | 📅 2026-09-09 - `Python` - A Python library for evaluating option trading strategies.
* [financial-engineering](https://github.com/federicomariamassari/financial-engineering) ⭐ 546 | 🐛 0 | 🌐 Python | 📅 2017-11-20 - `Python` - Applications of Monte Carlo methods to financial engineering projects, in Python.
* [pynance](https://github.com/GriffinAustin/pynance) ⭐ 477 | 🐛 8 | 🌐 Python | 📅 2021-02-03 - `Python` - Lightweight Python library for assembling and analyzing financial data.
* [py\_vollib](https://github.com/vollib/py_vollib) ⭐ 435 | 🐛 1 | 🌐 Python | 📅 2026-05-29 - `Python` - vollib Python implementation.
...
* [willowtree](https://github.com/federicomariamassari/willowtree) ⭐ 382 | 🐛 1 | 🌐 Python | 📅 2018-07-14 - `Python` - Robust and flexible Python implementation of the willow tree lattice for derivatives pricing.
* [rateslib](https://github.com/attack68/rateslib) ⭐ 363 | 🐛 24 | 📅 2026-05-20 - `Python` - A fixed income library for pricing bonds and bond futures, and derivatives such as IRS, cross-currency and FX swaps.
...
* [StochVolModels](https://github.com/ArturSepp/StochVolModels) ⭐ 237 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - `Python` - Pricing analytics and Monte Carlo simulation for stochastic volatility models, including the log-normal SV model and the Heston model.
...
* [QuantLib.jl](https://github.com/pazzo83/QuantLib.jl) ⭐ 143 | 🐛 10 | 🌐 Julia | 📅 2020-02-18 - `Julia` - Quantlib implementation in pure Julia.
...
* [Miletus.jl](https://github.com/JuliaComputing/Miletus.jl) ⭐ 94 | 🐛 5 | 🌐 Julia | 📅 2025-12-09 - `Julia` - A financial contract definition, modeling language, and valuation framework.
* [AbsBox](https://github.com/yellowbean/AbsBox) ⭐ 71 | 🐛 10 | 🌐 Python | 📅 2026-09-24 - `Python` - A Python based library to model cashflow for structured product like Asset-backed securities (ABS) and Mortgage-backed securities (MBS).
...
* [Pyderivatives](https://github.com/Julian-Beatty/Pyderivatives) ⭐ 47 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - `Python` - Toolkit for option pricing, implied volatility surfaces, risk-neutral densities, and pricing kernel surfaces with support for advanced models including Heston, Kou, and Bates.
...
* [r-quant](https://github.com/artyyouth/r-quant) ⭐ 34 | 🐛 0 | 🌐 R | 📅 2014-02-19 - `R` - R code for quantitative analysis in finance.
...
* [vanilla-option-pricers](https://github.com/ArturSepp/VanillaOptionPricers) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - `Python` - Fast, vectorised Black-Scholes-Merton and Bachelier pricers and implied volatility fitters, including inverse options for crypto derivatives.
...
* [flashalpha](https://github.com/FlashAlpha-lab/flashalpha-python) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-09-09 - `Python` - Python client for the FlashAlpha options analytics API.
...
* [QoX](https://github.com/bboutelje/qox-python-samples) ⭐ 5 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-15 - `Python` - Finite difference pricing library written in Rust.
...
* [hagan-sabr](https://github.com/moshejs/hagan-sabr) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-16 - `TypeScript` - SABR stochastic-volatility model (Hagan 2002 lognormal/normal expansions, Obłój correction, smile calibration); zero dependencies, matches QuantLib's sabrVolatility to 1e-9.
...
* [day-count-conventions](https://github.com/moshejs/day-count) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-16 - `TypeScript` - ISDA 2006 day-count conventions (30/360 family, ACT/360, ACT/365F, ACT/ACT ISDA and ICMA); zero dependencies.
...
* [TA-Lib Python](https://github.com/TA-Lib/ta-lib-python) ⭐ 12,255 | 🐛 134 | 🌐 Cython | 📅 2026-09-21 - `Python` - Python wrapper for TA-Lib (<https://ta-lib.org/>).
* [ta](https://github.com/bukosabino/ta) ⭐ 5,227 | 🐛 159 | 🌐 Jupyter Notebook | 📅 2026-03-18 - `Python` - Technical Analysis Library using Pandas (Python).
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,493 | 🐛 14 | 🌐 Java | 📅 2026-09-26 - `Java` - A Java library for technical analysis.
* [IndicatorGo](https://github.com/cinar/indicator) ⭐ 1,818 | 🐛 37 | 🌐 Go | 📅 2026-09-14 - `Golang` - IndicatorGo is a Golang module providing various stock technical analysis indicators, strategies, and a backtest framework for trading.
...
* [talipp](https://github.com/nardew/talipp) ⭐ 538 | 🐛 31 | 🌐 Python | 📅 2025-09-09 - `Python` - Incremental technical analysis library for Python.
...
* [IndicatorTS](https://github.com/cinar/indicatorts) ⭐ 477 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-21 - `JavaScript` - Indicator is a TypeScript module providing various stock technical analysis indicators, strategies, and a backtest framework for trading.
...
* [orderflow](https://github.com/tiagosiebler/orderflow) ⭐ 86 | 🐛 6 | 🌐 TypeScript | 📅 2025-03-31 - `JavaScript` - Orderflow trade aggregator for building Footprint Candles from exchange websocket data.
...
* [Wickra](https://github.com/wickra-lib/wickra) ⭐ 59 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - `Rust` `Python` `JavaScript` `C++` `C#` `Golang` `Java` `R` - Streaming-first technical-analysis library with a Rust core: 514 indicators updating in O(1) per tick, with bit-exact batch-vs-streaming results.
...
* [QuantWave](https://github.com/lavs9/quantwave) ⭐ 18 | 🐛 3 | 🌐 Rust | 📅 2026-09-20 - `Python` `Rust` `Polars` - Polars-native technical analysis and backtesting with bit-identical batch and streaming parity, plus an agent skill for consistent research-to-live strategy code.
* [fin-primitives](https://github.com/Mattbusel/fin-primitives) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - `Rust` - Financial market primitives in Rust: Price/Quantity/Symbol newtypes, BTreeMap order book, OHLCV aggregation, SMA/EMA/RSI indicators, position ledger with PnL, and composable risk monitor.
* [TechnicalIndicatorCharts.jl](https://github.com/g-gundam/TechnicalIndicatorCharts.jl) ⭐ 8 | 🐛 0 | 🌐 Julia | 📅 2026-09-17 - `Julia` - Visualize OnlineTechnicalIndicators.jl using LightweightCharts.jl.
...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 54,804 | 🐛 29 | 🌐 Python | 📅 2026-09-26 - `Python` - Free, open source crypto trading bot.

* [Qlib](https://github.com/microsoft/qlib) ⭐ 48,866 | 🐛 481 | 🌐 Python | 📅 2026-09-22 - `Python` - An AI-oriented Quantitative Investment Platform by Microsoft. Full ML pipeline of data processing, model training, back-testing; and covers the entire chain of quantitative investment: alpha seeking, risk modeling, portfolio optimization, and order execution.

* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,558 | 🐛 25 | 🌐 Python | 📅 2026-09-13 - `Python` - VeighNa is a Python-based open source quantitative trading system development framework.

* [ccxt](https://github.com/ccxt/ccxt) ⭐ 44,164 | 🐛 713 | 🌐 Python | 📅 2026-09-26 - `JavaScript` `Python` `PHP` - A JavaScript / Python / PHP cryptocurrency trading API with support for more than 100 bitcoin/altcoin exchanges.

* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 34,064 | 🐛 45 | 🌐 Python | 📅 2026-09-25 - `Python` - Natural-language multi-agent finance research agent with 29 swarm presets, 70 skills, and 28 auto-discovered tools; 7 backtest engines covering A-shares/US/Crypto/Futures/Forex/Options plus a cross-market CompositeEngine with shared capital pool; 5-source auto-fallback data layer (tushare/okx/yfinance/akshare/ccxt); 17-tool MCP server; includes trade-journal behavioral diagnostics for 同花顺/东财/富途 exports.

* [nautilus\_trader](https://github.com/nautechsystems/nautilus_trader) ⭐ 29,419 | 🐛 144 | 🌐 Rust | 📅 2026-09-26 - `Python` `Rust` - A high-performance algorithmic trading platform and event-driven backtester.

* [backtrader](https://github.com/mementum/backtrader) ⭐ 23,328 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - `Python` - Python Backtesting library for trading strategies.

* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,786 | 🐛 254 | 🌐 C# | 📅 2026-09-25 - `Python` `C#` - Lean Algorithmic Trading Engine by QuantConnect (Python, C#).

* [QuantConnect](https://github.com/QuantConnect/Lean) ⭐ 21,786 | 🐛 254 | 🌐 C# | 📅 2026-09-25 - `CSharp` - Lean Engine is an open-source fully managed C# algorithmic trading engine built for desktop and cloud usage.

* [machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading) ⭐ 21,038 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-09-24 - `Python` - Code and resources for Machine Learning for Algorithmic Trading.

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,117 | 🐛 367 | 🌐 Python | 📅 2024-02-13 - `Python` - Pythonic algorithmic trading library.

* [FinRL](https://github.com/AI4Finance-Foundation/FinRL) ⭐ 16,403 | 🐛 314 | 🌐 Jupyter Notebook | 📅 2026-09-26 - `Python` - A Deep Reinforcement Learning Library for Automated Trading in Quantitative Finance. NeurIPS 2020.

* [QUANTAXIS](https://github.com/yutiansut/quantaxis) ⭐ 11,236 | 🐛 240 | 🌐 Python | 📅 2026-09-18 - `Matlab` - Integrated Quantitative Toolbox with Matlab.

* [StockSharp](https://github.com/StockSharp/StockSharp) ⭐ 10,803 | 🐛 3 | 🌐 C# | 📅 2026-09-25 - `CSharp` - Algorithmic trading and quantitative trading open source platform to develop trading robots (stock markets, forex, crypto, bitcoins, and options).

* [vectorbt](https://github.com/polakowo/vectorbt) ⭐ 9,190 | 🐛 140 | 🌐 Python | 📅 2026-09-26 - `Python` - Find your trading edge, using a powerful toolkit for backtesting, algorithmic trading, and research.

* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,584 | 🐛 16 | 🌐 Python | 📅 2026-09-26 - `Python` - An advanced crypto trading bot written in Python.

* [quantstats](https://github.com/ranaroussi/quantstats) ⭐ 7,658 | 🐛 10 | 🌐 Python | 📅 2026-09-26 - `Python` - Portfolio analytics for quants, written in Python.

* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,796 | 🐛 31 | 🌐 Python | 📅 2026-09-24 - `Python` - A extendable, replaceable Python algorithmic backtest && trading framework supporting multiple securities.

* [OctoBot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,617 | 🐛 168 | 🌐 Python | 📅 2026-09-25 - `Python` - Open source cryptocurrency trading bot for high frequency, arbitrage, TA and social trading with an advanced web interface.

* [hftbacktest](https://github.com/nkaz001/hftbacktest) ⭐ 4,781 | 🐛 17 | 🌐 Rust | 📅 2025-12-23 - `Python` - A high-frequency trading and market-making backtesting tool accounts for limit orders, queue positions, and latencies, utilizing full tick data for trades and order books.

* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,315 | 🐛 22 | 🌐 Python | 📅 2026-07-01 - `Python` - the project using sql, pandas to provide an uniform and extendable way to record data, computing factors, select securities, backtesting, realtime trading and it could show all of them in clearly charts in realtime.

* [finmarketpy](https://github.com/cuemacro/finmarketpy) ⭐ 3,816 | 🐛 44 | 🌐 Python | 📅 2026-04-16 - `Python` - Python library for backtesting trading strategies and analyzing financial markets.

* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,546 | 🐛 9 | 🌐 Python | 📅 2026-09-21 - `Python` - Algorithmic Trading with Machine Learning.

* [Hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,530 | 🐛 4 | 🌐 C++ | 📅 2026-09-26 - `Python` `C++` - A base on Python/C++ open source high-performance quant framework for faster analysis and backtesting, contains the complete trading system components for reuse and combination.

* [Hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,530 | 🐛 4 | 🌐 C++ | 📅 2026-09-26 - `Python` `C++` - A base on Python/C++ open source high-performance quant framework for faster analysis and backtesting, contains the complete trading system components for reuse and combination. You can use python or c++ freely.

* [pysystemtrade](https://github.com/pst-group/pysystemtrade) ⭐ 3,526 | 🐛 37 | 🌐 Python | 📅 2026-09-26 - `Python` - pysystemtrade is the open source version of Robert Carver's backtesting and trading engine that implements systems according to the framework outlined in his book "Systematic Trading", which is further developed on his blog.

* [algorithmic-trading-with-python](https://github.com/chrisconlan/algorithmic-trading-with-python) ⭐ 3,488 | 🐛 6 | 🌐 Python | 📅 2021-06-01 - `Python` - Free `pandas` and `scikit-learn` resources for trading simulation, backtesting, and machine learning on financial data.

* [QSTrader](https://github.com/mhallsmoore/qstrader) ⭐ 3,473 | 🐛 16 | 🌐 Python | 📅 2024-06-30 - `Python` - QSTrader backtesting simulation engine.

* [bt](https://github.com/pmorissette/bt) ⭐ 2,989 | 🐛 15 | 🌐 Python | 📅 2026-09-25 - `Python` - Flexible Backtesting for Python.

* [Blankly](https://github.com/Blankly-Finance/Blankly) ⭐ 2,478 | 🐛 39 | 🌐 Python | 📅 2024-12-30 - `Python` - Fully integrated backtesting, paper trading, and live deployment.
...
* [Barter](https://github.com/barter-rs/barter-rs) ⭐ 2,314 | 🐛 91 | 🌐 Rust | 📅 2026-08-24 - `Rust` - Open-source Rust framework for building event-driven live-trading & backtesting systems.

* [Investing algorithm framework](https://github.com/coding-kitties/investing-algorithm-framework) ⭐ 2,133 | 🐛 80 | 🌐 Python | 📅 2026-09-25 - `Python` - Framework for developing, backtesting, and deploying automated trading algorithms.

* [Lumibot](https://github.com/Lumiwealth/lumibot) ⭐ 2,091 | 🐛 93 | 🌐 Python | 📅 2026-09-26 - `Python` - Algorithmic trading framework where the same code runs for backtesting and live trading across stocks, options, crypto, futures, and forex with multiple brokers including Alpaca, Interactive Brokers, Tradier, and Schwab.

* [zipline-reloaded](https://github.com/stefan-jansen/zipline-reloaded) ⭐ 1,948 | 🐛 48 | 🌐 Python | 📅 2026-01-06 - `Python` - Zipline, a Pythonic Algorithmic Trading Library.

* [Intelligent Trading Bot](https://github.com/asavinov/intelligent-trading-bot) ⭐ 1,871 | 🐛 46 | 🌐 Python | 📅 2026-08-30 - `Python` - Automatically generating signals and trading based on machine learning and feature engineering.

* [fastquant](https://github.com/enzoampil/fastquant) ⭐ 1,758 | 🐛 82 | 🌐 Jupyter Notebook | 📅 2023-09-15 - `Python` - fastquant allows you to easily backtest investment strategies with as few as 3 lines of python code.

* [AlphaPy](https://github.com/ScottfreeLLC/AlphaPy) ⭐ 1,755 | 🐛 19 | 🌐 Python | 📅 2025-08-24 - `Python` - Automated Machine Learning \[AutoML] with Python, scikit-learn, Keras, XGBoost, LightGBM, and CatBoost.

* [PandoraTrader](https://github.com/pegasusTrader/PandoraTrader) ⭐ 1,474 | 🐛 8 | 🌐 C++ | 📅 2025-10-18 - `CPP` - A C++ CTP trading framework, with very clear logic.

* [tda-api](https://github.com/alexgolec/tda-api) ⭐ 1,326 | 🐛 39 | 🌐 Python | 📅 2024-06-16 - `Python` - Gather data and trade equities, options, and ETFs via TDAmeritrade.

* [qf-lib](https://github.com/quarkfin/qf-lib) ⭐ 970 | 🐛 13 | 🌐 Python | 📅 2026-08-31 - `Python` - QF-Lib is a Python library that provides high quality tools for quantitative finance.

* [basana](https://github.com/gbeced/basana) ⭐ 869 | 🐛 1 | 🌐 Python | 📅 2026-08-09 - `Python` - A Python async and event driven framework for algorithmic trading, with a focus on crypto currencies.

* [aat](https://github.com/AsyncAlgoTrading/aat) ⭐ 836 | 🐛 1 | 🌐 C++ | 📅 2026-07-27 - `Python` - Async Algorithmic Trading Engine.
...
* [PRISM-INSIGHT](https://github.com/dragon1086/prism-insight) ⭐ 767 | 🐛 7 | 🌐 Python | 📅 2026-09-26 - `Python` - AI-powered stock analysis system with 13 specialized agents, automated trading via KIS API, supporting Korean & US markets.
...
* [TradeFrame](https://github.com/rburkholder/trade-frame) ⭐ 678 | 🐛 2 | 🌐 C++ | 📅 2026-09-23 - `CPP` - C++ 17 based framework/library (with sample applications) for testing options based automated trading ideas using DTN IQ real time data feed and Interactive Brokers (TWS API) for trade execution. Comes with built-in [Option Greeks/IV](https://github.com/rburkholder/trade-frame/tree/master/lib/TFOptions) ⭐ 678 | 🐛 2 | 🌐 C++ | 📅 2026-09-23 calculation library.

* [qis](https://github.com/ArturSepp/QuantInvestStrats) ⭐ 638 | 🐛 0 | 🌐 Python | 📅 2026-09-26 - `Python` - Performance analytics, portfolio backtesting, risk analysis, and factsheet reporting.

* [fast-trade](https://github.com/jrmeier/fast-trade) ⭐ 597 | 🐛 4 | 🌐 Python | 📅 2026-09-24 - `Python` - A library built with backtest portability and performance in mind for backtest trading strategies.
...
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 433 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-21 - `Python` - Self-hosted execution engine for algorithmic trading bots. Write strategies in Python, TypeScript, Rust, C++, C#, Scala, or Haskell and deploy with one command. Each bot runs in an isolated container with scheduled or streaming execution.
...
* [pinkfish](https://github.com/fja05680/pinkfish) ⭐ 306 | 🐛 6 | 🌐 Python | 📅 2026-09-18 - `Python` - A backtester and spreadsheet library for security analysis.

* [moonshot](https://github.com/quantrocket-llc/moonshot) ⭐ 280 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - `Python` - Vectorized backtester and trading engine for QuantRocket based on Pandas.

* [Trading Strategy](https://github.com/tradingstrategy-ai/getting-started) ⭐ 253 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-09-25 - `Python` - TradingStrategy.ai is a market data, backtesting, live trading and investor management framework for decentralised finance.
...
* [StrateQueue](https://github.com/StrateQueue/StrateQueue) ⭐ 214 | 🐛 17 | 🌐 Python | 📅 2026-05-19 - `Python` - An open‑source, broker‑agnostic Python library that lets you seamlessly deploy strategies from any major backtesting engine to live (or paper) trading with zero code changes and built‑in safety controls.
...
* [AgentQuant](https://github.com/OnePunchMonk/AgentQuant) ⭐ 205 | 🐛 19 | 🌐 Python | 📅 2026-09-25 - `Python` - Trading-strategy research framework with iterative proposal generation, backtesting, SQLite memory, holdout evaluation, walk-forward experiments, and experimental genetic-algorithm and differential-evolution optimizers.

* [PyLOB](https://github.com/DrAshBooth/PyLOB) ⭐ 204 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - `Python` - Fully functioning fast Limit Order Book written in Python.

* [backtrader (cloudQuant fork)](https://github.com/cloudQuant/backtrader) ⭐ 187 | 🐛 0 | 🌐 Python | 📅 2026-09-21 - `Python` - Actively maintained, high-performance backtesting and live trading framework with AI-assisted strategy tooling (MCP server, skills, agent, web platform). Fork of backtrader.

* [TradeSight](https://github.com/rmbell09-lang/tradesight) ⭐ 171 | 🐛 7 | 🌐 Python | 📅 2026-07-15 - `Python` - Self-hosted AI trading platform with strategy evolution, technical analysis, backtesting, and paper trading via Alpaca.
...
* [OrderMatchingEngine](https://github.com/PIYUSH-KUMAR1809/order-matching-engine) ⭐ 166 | 🐛 0 | 🌐 C++ | 📅 2026-09-08 - `CPP` - A production-grade, lock-free, high-frequency trading matching engine achieving 150M+ orders/sec.

* [SHORTLIST](https://github.com/zc6503204-collab/stock-strategy-dashboard) ⭐ 128 | 🐛 5 | 🌐 Python | 📅 2026-09-23 - `Python` - Local-first macOS workbench for A-share and US stock strategy screening, paper trading, position sizing, and risk alerts with read-only broker integrations.
...
* [NexusFix](https://github.com/StratCraftsAI/NexusFix) ⭐ 100 | 🐛 5 | 🌐 C++ | 📅 2026-07-21 - `CPP` - C++23 FIX protocol engine with zero-copy parsing and SIMD acceleration, 3x faster than QuickFIX.
...
* [rust\_bt](https://github.com/jensnesten/rust_bt) ⭐ 88 | 🐛 1 | 🌐 Rust | 📅 2026-01-05 - `Python` - A high performance, low-latency backtesting engine for testing quantitative trading strategies on historical and live data in Rust.
...
* [Orallexa](https://github.com/alex-jb/orallexa-ai-trading-agent) ⭐ 67 | 🐛 5 | 🌐 Python | 📅 2026-07-12 - `Python` - AI trading operating system with 9 ML models (RF, XGBoost, EMAformer, MOIRAI-2, Chronos-2, DDPM, PPO RL, GNN, LR) ranked by Sharpe ratio, Claude AI synthesis with dual-tier routing (\~$0.003/analysis), real-time Next.js dashboard, Alpaca paper trading, and 277 automated tests.
...
* [aurumq-rl](https://github.com/yupoet/aurumq-rl) ⭐ 53 | 🐛 18 | 🌐 Python | 📅 2026-07-24 - `Python` - Reinforcement learning stock-selection framework for the China A-share market with multi-source factor input (alpha101 + main-force flow + hot-money seats + northbound + institutional + fundamentals), board-aware price limits, and ONNX CPU inference.

* [binary-martingale](https://github.com/metaperl/binary-martingale) ⭐ 49 | 🐛 1 | 🌐 Python | 📅 2017-10-16 - `Python` - Computer program to automatically trade binary options martingale style.

* [OctoBot Script](https://github.com/Drakkar-Software/OctoBot-Script) ⭐ 48 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-13 - `Python` - A quant framework to create cryptocurrencies strategies - from backtesting to optimization to livetrading.
...
* [Algo-Trading-Skills](https://github.com/HimanshuJ16/Algo-Trading-Skills) ⭐ 46 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - `Python` `AI` `Agent-Skills` - Library of 501 agentskills.io-format skills giving AI coding agents trading-infrastructure playbooks for order idempotency, look-ahead-bias elimination, kill switches, execution algorithms and point-in-time data, each with a standalone Python reference implementation and its own unittest suite.

* [jquantstats](https://github.com/Jebel-Quant/jquantstats) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - `Python` - Modern variation of quantstats, with additional features and performance improvements.

* [TradeClaw](https://github.com/naimkatiman/tradeclaw) ⭐ 42 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - `Node.js` `TypeScript` - Open-source self-hosted AI trading signal platform. Generates buy/sell signals using RSI, MACD, EMA, Bollinger Bands for forex, crypto and commodities. Deployable via Docker Compose. ([Demo](https://tradeclaw.win/dashboard))

* [Inalpha](https://github.com/mirror29/inalpha) ⭐ 40 | 🐛 32 | 🌐 Python | 📅 2026-09-21 - `Python` `TypeScript` - Conversational multi-agent quant framework where agents rank currently-effective factors for entry timing (time-series rank IC), write complete strategy code that passes sandboxed audit before backtesting, and evolve strategies under multi-objective fitness; every order requires machine approval and the LLM never has a direct order path.

* [PythonTradingFramework](https://github.com/JustinGuese/python_tradingbot_framework) ⭐ 40 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-26 - `Python` - Python algorithmic trading bot framework for Kubernetes: backtesting, hyperparameter optimization, 150+ technical analysis indicators (RSI, MACD, Bollinger Bands, ADX), portfolio management, PostgreSQL integration, Helm deployment, CronJob scheduling. Minimal overhead, production-ready, Yahoo Finance data.

* [TraderHarness](https://github.com/HephaestLab/TraderHarness) ⭐ 40 | 🐛 1 | 🌐 Python | 📅 2026-08-22 - `Python` - Contamination-resistant A-share backtesting environment for LLM trading agents with point-in-time masking, entity/date anonymization, fingerprinted replay, and trajectory (SFT) export.

* [Manifold-BT](https://github.com/manifoldbt/manifoldbt) ⭐ 36 | 🐛 3 | 🌐 Python | 📅 2026-09-26 - `Python` `Rust` - High-performance Rust-powered backtesting engine for quantitative research with parameter sweeps, walk-forward and Monte Carlo.

* [purgedcv](https://github.com/eslazarev/purged-cross-validation) ⭐ 35 | 🐛 2 | 🌐 Python | 📅 2026-09-26 - `Python` - scikit-learn-compatible purged, group-purged, and combinatorial purged (CPCV) cross-validation, walk-forward splitting, and backtest-overfitting statistics (deflated and probabilistic Sharpe ratios, PBO, minimum backtest length) to prevent leakage and overfitting when backtesting trading strategies.
...
* [TrendFollowingSystems](https://github.com/ArturSepp/TrendFollowingSystems) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - `Python` - Closed-form expected returns, Sharpe ratios, and skewness of trend-following systems, with complete implementations and multi-decade futures backtests.

* [mt5-httpapi](https://github.com/psyb0t/mt5-httpapi) ⭐ 28 | 🐛 4 | 🌐 Python | 📅 2026-09-10 - `Python` `REST` `MCP` - MetaTrader 5 in a Windows VM (Docker + QEMU/KVM) over REST and MCP: market data, order/position/history management for automated trading and bots, the strategy-tester (backtesting) API, and server-side indicators (RSI/MACD/Bollinger/ADX/VWAP/Ichimoku, order blocks, FVGs). Multi-broker, multi-account.

* [DepthSight](https://github.com/depthsight-pro/depthsight) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2026-09-26 - `Python` `TypeScript` - Self-hosted visual algo-trading platform featuring a drag-and-drop strategy builder, an AI co-pilot, and integrated billing.
...
* [pyhood](https://github.com/jamestford/pyhood) ⭐ 22 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - `Python` - Robinhood API client for unattended automation: after the first approved login, sessions renew from a stored refresh token with no password or device approval prompt. Covers stocks, equity and index options with Greeks, futures, IRA accounts, and the official Crypto Trading API.

* [Fastback.jl](https://github.com/rbeeli/Fastback.jl) ⭐ 22 | 🐛 1 | 🌐 Julia | 📅 2026-09-23 - `Julia` - Blazing fast Julia backtester.

* [income-desk](https://github.com/nitinblue/income-desk) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - `Python` - Systematic options trading intelligence for small accounts with desk-based portfolio management, pre-trade validation, and multi-broker consolidation.
...
* [orderbook](https://github.com/intrepidkarthi/orderbook) ⭐ 17 | 🐛 7 | 🌐 Go | 📅 2026-09-01 - `Go` `WebAssembly` - Embeddable limit order book and matching engine with integer-exact pricing, a single-writer core and write-ahead-log crash recovery, plus a microstructure research harness whose order-flow-imbalance, Kyle's lambda and CVD studies are measured against simulator ground truth.
...
* [VerumTrade](https://github.com/muye1202/VerumTrade) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-06-29 - `Python` - A reasoning & decision-trace visible Multi-agent LLM trading-research framework where bull/bear analysts debate each ticker and every decision cites the evidence it rests on.
...
* [orderflow-metrics](https://github.com/twowaymind/orderflow-metrics) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - `TypeScript` `Python` - Dependency-free market-microstructure metrics: order-flow imbalance (OFI), VPIN, information-driven bars, realized volatility / covariance / beta, market impact, Kyle's lambda, trade-sign classification, and limit-order-book reconstruction. Same API in TypeScript (npm) and Python (PyPI).

* [Planar.jl](https://github.com/BubbleParticles/Planar.jl) ⭐ 11 | 🐛 1 | 🌐 Julia | 📅 2026-09-24 - `Julia` - Trading framework built around CCXT with Zarr-backed OHLCV persistence, contiguity-checked data feeds, isolated-margin position management, and a loop-based backtester sharing strategy code across simulation, paper, and live modes.
...
* [Dive Into Crypto](https://github.com/nazmiefearmutcu/dive-into-crypto) ⭐ 8 | 🐛 14 | 🌐 Kotlin | 📅 2026-09-16 - `Python` `Kotlin` - Binance perpetual-futures scanner with technical-indicator consensus, multi-timeframe analysis, and desktop and Android interfaces.

* [YABTE](https://github.com/bsdz/yabte) ⭐ 7 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-02-15 - `Python` - Yet Another (Python) BackTesting Engine.

* [ShowMe](https://github.com/nazmiefearmutcu/showMe) ⭐ 7 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-23 - `Python` `Rust` `TypeScript` - Open-source native macOS market cockpit. 12-timeframe consensus scan across 3370 symbols (crypto + equity + ETF + FX + commodity + bond), 23 technical indicators with per-market calibration, real WebSocket streaming. Tauri shell + Python sidecar (FastAPI) + React UI; 110+ exchanges via ccxt.
...
* [backtester-mcp](https://pypi.org/project/backtester-mcp/) - `Python` - Local-first backtesting engine with built-in overfitting checks (PBO, deflated Sharpe, bootstrap CI, walk-forward) and a native MCP server for AI agents. [GitHub](https://github.com/bcosm/backtester-mcp) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-04-17
...
* [exitkit](https://github.com/charlieyanhx/exitkit) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - `Python` - Catalogue of twenty-seven position-exit policies (stop-loss, take-profit, time, volatility, signal-reversal and convergence) behind one interface, with a drop-in adapter for backtesting.py.

* [midas-core](https://github.com/w2ur/midas-core) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2026-09-26 - `Python` - Multi-agent paper-trading framework where LLM agents author orders and a separate broker process enforces fifteen fill-time safety rails; each fill is stamped with the git commit it executed against for reproducibility.
...
* [falsification-ledger](https://github.com/holdout-labs/falsification-ledger) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - `Python` - Hash-chained pre-registration and falsification ledger for research claims: write down what evidence would kill your claim before seeing the data; append-only JSONL with a sha256 chain (`fl verify` detects any edit), Wilson-CI hit-rate vs the random baseline, fail-closed falsification report contracts. [PyPI](https://pypi.org/project/falsification-ledger/)
...
* [Ghostfolio](https://github.com/ghostfolio/ghostfolio) ⭐ 9,356 | 🐛 331 | 🌐 TypeScript | 📅 2026-09-26 - `JavaScript` - Wealth management software to keep track of financial assets like stocks, ETFs or cryptocurrencies and make solid, data-driven investment decisions.
...
* [PyPortfolioOpt](https://github.com/PyPortfolio/PyPortfolioOpt) ⭐ 6,052 | 🐛 116 | 🌐 Jupyter Notebook | 📅 2026-07-07 - `Python` - Financial portfolio optimization in python, including classical efficient frontier and advanced methods.
* [mlfinlab](https://github.com/hudson-and-thames/mlfinlab) ⭐ 4,932 | 🐛 49 | 🌐 Python | 📅 2023-10-02 - `Python` - Implementations regarding "Advances in Financial Machine Learning" by Marcos Lopez de Prado. (Feature Engineering, Financial Data Structures, Meta-Labeling).
* [Riskfolio-Lib](https://github.com/dcajasn/Riskfolio-Lib) ⭐ 4,516 | 🐛 17 | 🌐 C++ | 📅 2026-09-24 - `Python` - Portfolio Optimization and Quantitative Strategic Asset Allocation in Python.
* [Eiten](https://github.com/tradytics/eiten) ⭐ 3,303 | 🐛 18 | 🌐 Python | 📅 2022-07-30 - `Python` - Eiten is an open source toolkit by Tradytics that implements various statistical and algorithmic investing strategies such as Eigen Portfolios, Minimum Variance Portfolios, Maximum Sharpe Ratio Portfolios, and Genetic Algorithms based Portfolios.
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 2,435 | 🐛 48 | 🌐 Python | 📅 2026-09-26 - `Python` - Python library for portfolio optimization built on top of scikit-learn. It provides a unified interface and sklearn compatible tools to build, tune and cross-validate portfolio models.
* [FinQuant](https://github.com/fmilthaler/FinQuant) ⭐ 1,826 | 🐛 18 | 🌐 Python | 📅 2023-11-04 - `Python` - A program for financial portfolio management, analysis and optimization.
* [empyrical](https://github.com/quantopian/empyrical) ⭐ 1,514 | 🐛 37 | 🌐 Python | 📅 2024-07-26 - `Python` - Common financial risk and performance metrics.
* [fecon235](https://github.com/rsvp/fecon235) ⭐ 1,279 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2023-01-20 - `Python` - Computational tools for financial economics include: Gaussian Mixture model of leptokurtotic risk, adaptive Boltzmann portfolios.
* [DeepDow](https://github.com/jankrepl/deepdow) ⭐ 1,184 | 🐛 28 | 🌐 Python | 📅 2024-01-24 - `Python` - Portfolio optimization with deep learning.
...
* [universal-portfolios](https://github.com/Marigold/universal-portfolios) ⭐ 863 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2026-07-31 - `Python` - Collection of algorithms for online portfolio selection.
* [pyfolio-reloaded](https://github.com/stefan-jansen/pyfolio-reloaded) ⭐ 616 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2025-12-15 - `Python` - Portfolio and risk analytics in Python. [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,425 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 fork.
...
* [empyrical-reloaded](https://github.com/stefan-jansen/empyrical-reloaded) ⭐ 122 | 🐛 8 | 🌐 Python | 📅 2025-12-12 - `Python` - Common financial risk and performance metrics. [empyrical](https://github.com/quantopian/empyrical) ⭐ 1,514 | 🐛 37 | 🌐 Python | 📅 2024-07-26 fork.
...
* [OptimalPortfolios](https://github.com/ArturSepp/OptimalPortfolios) ⭐ 95 | 🐛 1 | 🌐 Python | 📅 2026-09-26 - `Python` - Optimisation analytics for constructing and backtesting optimal multi-asset portfolios: covariance estimation, rolling optimisation, and performance reporting in one pipeline.
...
* [factorlasso](https://github.com/ArturSepp/factorlasso) ⭐ 28 | 🐛 2 | 🌐 Python | 📅 2026-09-25 - `Python` - Sparse multi-asset factor models with cell-level sign constraints, prior-centred shrinkage, and hierarchical clustering group LASSO (HCGL); scikit-learn compatible.
...
* [goal-based-allocation](https://github.com/ArturSepp/GoalBasedAllocation) ⭐ 13 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - `Python` - Dynamic mean-variance portfolio allocation under regime-switching jump-diffusions with wealth floors, solved analytically via Laplace transforms.
...
* [alphalens](https://github.com/quantopian/alphalens) ⭐ 4,457 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2024-02-12 - `Python` - Performance analysis of predictive alpha factors.

* [Spectre](https://github.com/Heerozh/spectre) ⭐ 825 | 🐛 10 | 🌐 Python | 📅 2025-04-15 - `Python` - GPU-accelerated Factors analysis library and Backtester.

* [alphalens-reloaded](https://github.com/stefan-jansen/alphalens-reloaded) ⭐ 657 | 🐛 14 | 🌐 Python | 📅 2025-12-15 - `Python` - Performance analysis of predictive (alpha) stock factors.

* [QuantGPT](https://github.com/Miasyster/QuantGPT) ⭐ 472 | 🐛 5 | 🌐 Python | 📅 2026-05-20 - `Python` - Agent-driven A-share factor research engine with 8 MCP tools covering hypothesis design, backtesting, scoring, and anti-overfit detection.

* [Alpha Skills](https://github.com/VernonOY/alpha-skills) ⭐ 111 | 🐛 0 | 📅 2026-04-14 - `Python` - AI skills for quantitative factor research: discover, evaluate, mine, backtest, and monitor factors through any AI coding assistant. Supports A-share, HK, and US markets.

* [ml-quant-trading](https://github.com/initial-d/ml-quant-trading) ⭐ 89 | 🐛 3 | 🌐 Python | 📅 2026-09-25 - `Python` - PyTorch research stack for multi-factor analysis, bias correction, portfolio optimization, and reproducible backtesting.
...
* [quant-lab-alpha](https://github.com/husainm97/quant-lab-alpha) ⭐ 38 | 🐛 2 | 🌐 Python | 📅 2026-05-17 - `Python` - Open-source investment analytics platform bridging academic research and retail finance.

* [Lacuna](https://github.com/eyenoticeall/Lacuna) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - `Python` `Rust` - Engine-agnostic quantitative research validation for detecting leakage, overfitting, fragile results, unrealistic costs, and missing point-in-time evidence.

* [DUEL](https://github.com/duelstocks/duel-algorithm) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-22 - `Python` `SEC EDGAR` - Open-source algorithm that scores two US-listed companies against each other on 8 fundamentals computed directly from SEC EDGAR XBRL data (10-K/10-Q); live comparison tool at duelstocks.com.

* [Perception-XAlpha Lite](https://github.com/xuxingjiankr-cpu/perception-xalpha-lite) ⭐ 2 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - `Python` - Backtest-overfitting audit for factor research: CSCV probability of backtest overfitting, deflated Sharpe against the declared trial count, White's Reality Check, point-in-time universe membership and disclosure-date alignment. Ships a worked example in which 24 pure-noise series produce a 1.11 Sharpe and the audit says so.
...
* [Asset News Sentiment Analyzer](https://github.com/KVignesh122/AssetNewsSentimentAnalyzer) ⭐ 200 | 🐛 0 | 🌐 Python | 📅 2026-07-15 - `Python` - Sentiment analysis and report generation package for financial assets and securities utilizing GPT models.
...
* [Facebook Prophet](https://github.com/facebook/prophet) ⭐ 20,418 | 🐛 455 | 🌐 Python | 📅 2026-08-27 - `Python` - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
* [statsmodels](https://www.statsmodels.org/stable/) - `Python` - Python module that allows users to explore data, estimate statistical models, and perform statistical tests. [GitHub](https://github.com/statsmodels/statsmodels) ⭐ 11,654 | 🐛 2,823 | 🌐 Python | 📅 2026-09-26
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,432 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-07-06 - `Python` - Automatic extraction of relevant features from time series.
* [gluon-ts](https://github.com/awslabs/gluonts) ⭐ 5,244 | 🐛 483 | 🌐 Python | 📅 2026-07-31 - `Python` - vProbabilistic time series modeling in Python.
* [PyFlux](https://github.com/RJT1990/pyflux) ⭐ 2,136 | 🐛 93 | 🌐 Python | 📅 2023-10-24 - `Python` - Python library for timeseries modelling and inference (frequentist and Bayesian) on models.
* [pmdarima](https://github.com/alkaline-ml/pmdarima) ⭐ 1,737 | 🐛 66 | 🌐 Python | 📅 2025-11-17 - `Python` - A statistical library designed to fill the void in Python's time series analysis capabilities, including the equivalent of R's auto.arima function.
* [ARCH](https://github.com/bashtage/arch) ⭐ 1,576 | 🐛 53 | 🌐 Python | 📅 2026-09-24 - `Python` - ARCH models in Python.
...
* [tidyquant](https://github.com/business-science/tidyquant) ⭐ 916 | 🐛 95 | 🌐 R | 📅 2026-09-01 - `R` - Bringing financial analysis to the tidyverse.
...
* [tidypredict](https://tidypredict.tidymodels.org/) - `R` - Run predictions inside the database. [GitHub](https://github.com/tidymodels/tidypredict) ⭐ 264 | 🐛 6 | 🌐 R | 📅 2026-09-09
* [PineForge](https://github.com/pineforge-4pass/pineforge-engine) ⭐ 188 | 🐛 6 | 🌐 C++ | 📅 2026-09-26 - `C++` - Deterministic offline PineScript v6 → C++ backtest runtime, validated trade-for-trade against TradingView (245/246 strict, 0 engine bugs). Runs locally via Docker and is drivable by AI agents through a bundled MCP server.
...
* [OpenBB](https://github.com/OpenBB-finance/OpenBB) ⭐ 73,473 | 🐛 96 | 🌐 Python | 📅 2026-09-26 - `Python` - Open-source financial data platform with extensible provider integrations, a Python interface, a command-line interface, and a local REST API.
* [Fincept Terminal](https://github.com/Fincept-Corporation/FinceptTerminal) ⭐ 31,990 | 🐛 8 | 🌐 C++ | 📅 2026-09-19 - `Python` - Advance Data Based A.I Terminal for all Types of Financial Asset Research.
* [yfinance](https://github.com/ranaroussi/yfinance) ⭐ 25,377 | 🐛 106 | 🌐 Python | 📅 2026-09-25 - `Python` - Yahoo! Finance market data downloader (+faster Pandas Datareader).
* [akshare](https://github.com/akfamily/akshare) ⭐ 22,748 | 🐛 4 | 🌐 Python | 📅 2026-09-23 - `Python` - AkShare is an elegant and simple financial data interface library for Python, built for human beings! <https://akshare.readthedocs.io>.
* [FinanceDatabase](https://github.com/JerBouma/FinanceDatabase) ⭐ 9,355 | 🐛 5 | 🌐 Python | 📅 2026-09-20 - `Python` - This is a database of 300.000+ symbols containing Equities, ETFs, Funds, Indices, Currencies, Cryptocurrencies and Money Markets.
* [FinanceToolkit](https://github.com/JerBouma/FinanceToolkit) ⭐ 5,380 | 🐛 10 | 🌐 Python | 📅 2026-09-10 - `Python` - Toolkit with 200+ financial metrics including 80+ financial ratios, 30+ technical indicators, 20+ risk and performance metrics and 50+ macro indicators which pulls from Financial Modeling Prep, Yahoo Finance, OECD, GMBD and more.
* [alpha\_vantage](https://github.com/RomelTorres/alpha_vantage) ⭐ 4,925 | 🐛 3 | 🌐 Python | 📅 2026-07-26 - `Python` - A python wrapper for Alpha Vantage API for financial data.
* [pandas-datareader](https://github.com/pydata/pandas-datareader) ⭐ 3,272 | 🐛 147 | 🌐 Python | 📅 2026-07-21 - `Python` - Python module to get data from various sources (Google Finance, Yahoo Finance, FRED, OECD, Fama/French, World Bank, Eurostat...) into Pandas datastructures such as DataFrame, Panel with a caching mechanism.
* [edgartools](https://github.com/dgunning/edgartools) ⭐ 2,749 | 🐛 29 | 🌐 Python | 📅 2026-09-26 - `Python` - AI-native SEC EDGAR library with XBRL financials, clean text extraction, 17+ typed forms, and pandas DataFrames.
* [findatapy](https://github.com/cuemacro/findatapy) ⭐ 2,126 | 🐛 28 | 🌐 Python | 📅 2026-07-02 - `Python` - Python library to download market data via Bloomberg, Quandl, Yahoo etc.
* [investpy](https://github.com/alvarobartt/investpy) ⭐ 1,857 | 🐛 244 | 🌐 Python | 📅 2026-04-13 - `Python` - Financial Data Extraction from Investing.com with Python! <https://investpy.readthedocs.io/>.
* [wallstreet](https://github.com/mcdallas/wallstreet) ⭐ 1,700 | 🐛 18 | 🌐 Python | 📅 2024-07-06 - `Python` - Real time stock and option data.
* [FinanceDataReader](https://github.com/FinanceData/FinanceDataReader) ⭐ 1,545 | 🐛 54 | 🌐 Python | 📅 2026-05-13 - `Python` - Open Source Financial data reader for U.S, Korean, Japanese, Chinese, Vietnamese Stocks.
* [yahoo-finance](https://github.com/yahoo-finance/yahoo-finance) ⭐ 1,450 | 🐛 88 | 🌐 Python | 📅 2023-12-25 - `Python` - Python module to get stock data from Yahoo! Finance.
...
* [googlefinance](https://github.com/hongtaocai/googlefinance) ⭐ 833 | 🐛 32 | 🌐 Python | 📅 2018-09-23 - `Python` - Python module to get real-time stock data from Google Finance API.
* [defeatbeta-api](https://github.com/defeat-beta/defeatbeta-api) ⭐ 755 | 🐛 10 | 🌐 Python | 📅 2026-09-25 - `Python` - An open-source alternative to Yahoo Finance's market data APIs with higher reliability.
* [jugaad-data](https://github.com/jugaad-py/jugaad-data) ⭐ 581 | 🐛 27 | 🌐 Python | 📅 2026-09-23 - `Python` - Download historical and live stock data from NSE (National Stock Exchange of India), BSE, and RBI.
...
* [Trading Strategy](https://github.com/tradingstrategy-ai/trading-strategy/) ⭐ 379 | 🐛 10 | 🌐 Python | 📅 2026-09-22 - `Python` - download price data for decentralised exchanges and lending protocols (DeFi).
...
* [market-prices](https://github.com/maread99/market_prices) ⭐ 106 | 🐛 10 | 🌐 Python | 📅 2026-09-15 - `Python` - Create meaningful OHLCV datasets from knowledge of [exchange-calendars](https://github.com/gerrymanoim/exchange_calendars) ⭐ 668 | 🐛 28 | 🌐 Python | 📅 2026-09-24 (works out-the-box with data from Yahoo Finance).
* [rb3](https://github.com/ropensci/rb3) ⭐ 105 | 🐛 24 | 🌐 R | 📅 2026-09-14 - `R` - A bunch of downloaders and parsers for data delivered from B3.
...
* [finalytics](https://github.com/Nnamdi-sys/finalytics) ⭐ 76 | 🐛 2 | 🌐 Rust | 📅 2026-05-01 - `Rust` - A rust library for financial data analysis.
...
* [tidyfinance](https://github.com/tidy-finance/r-tidyfinance) ⭐ 27 | 🐛 2 | 🌐 R | 📅 2026-09-24 - `R` - Tidy Finance helper functions to download financial data and process the raw data into a structured Format (tidy data), including.
...
* [BloombergFetch](https://github.com/ArturSepp/BloombergFetch) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - `Python` - Bloomberg Desktop API data (prices, implied volatilities, fundamentals) as pandas DataFrames via blpapi.
...
* [fin-stream](https://github.com/Mattbusel/fin-stream) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - `Rust` - Real-time market data streaming in Rust: lock-free SPSC ring buffer, 100K+ ticks/second ingestion, multi-timeframe OHLCV construction, and Lorentz transforms on financial time series.
...
* [Cambio Uruguay](https://cambio-uruguay.com) - `TypeScript` `REST` `MCP` - Collectors and public API for Uruguayan retail buy/sell exchange rates and historical series by source and quote type. [GitHub](https://github.com/eduair94/cambio-uruguay) ⭐ 7 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-26
* [OpenChainBench](https://openchainbench.com) - `Go` `TypeScript` - Open benchmark harnesses for blockchain RPC latency, perpetual-market execution costs and funding, bridge quotes, and oracle price deviations. [GitHub](https://github.com/ChainBench/OpenChainBench) ⭐ 7 | 🐛 1 | 🌐 Go | 📅 2026-09-26
...
* [itch-book](https://github.com/groovg/itch-book) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2026-09-21 - `Python` - NASDAQ TotalView-ITCH 5.0 day files to Parquet: BBO, trades, order-by-order messages with the resting side already resolved, and MBP depth; downloads and verifies the free emi.nasdaq.com samples.
* [treasury-fiscaldata](https://github.com/moshejs/treasury-fiscaldata) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-16 - `TypeScript` - Typed client for the US Treasury FiscalData API (debt, average interest rates, exchange rates) with pagination and filtering; no API key required.
* [Horus Flow](https://github.com/horustechltd/horus-flow-mcp) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-26 - `Python` - Order-flow analytics with order-book imbalance and rolling trade-delta calculations, plus an MCP interface.
...
* [Dividend Data Toolkit](https://github.com/holaclea/dividend-data-toolkit) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - `Python` `Data` - Dated SCHD payment and holdings snapshots with source URLs, data dictionaries, and Python tools for split-aware dividend windows and ETF company-exposure checks. [Website](https://dividendsteps.com/)
* [Market Brief](https://github.com/beepboop2025/market-brief) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-13 - `Python` `JavaScript` - Source-linked money-market, capital-market, and liquidity briefs with local snapshot comparisons and explicit missing-data states.
* [newyorkfed](https://github.com/moshejs/newyorkfed) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-16 - `TypeScript` - Client for the NY Fed Markets Data API: SOFR/EFFR/OBFR reference rates, SOFR averages and index, and SOMA holdings; no API key required.
* [commitments-of-traders](https://github.com/moshejs/commitments-of-traders) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-16 - `TypeScript` - Client for the CFTC Commitments of Traders reports (Legacy, Disaggregated, TFF; futures-only and combined) via the official Socrata API.
...
* [The Gold Barometer](https://github.com/thegoldbarometer/data) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-25 - `Python` - Daily gold buying-conditions score (0-100), free JSON API and CC BY dataset back to 1971.
...
* [The Stall](https://github.com/thebrierfox/the-stall) ⭐ 0 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-21 - `JavaScript` `MCP` - Self-hostable data and analytics service with equity technical indicators, multi-chain portfolio valuation, market-data adapters, and MCP interfaces.
...
* [pmxt](https://github.com/pmxt-dev/pmxt) ⭐ 2,169 | 🐛 1,346 | 🌐 TypeScript | 📅 2026-07-18 - `Python` `JavaScript` - The CCXT for prediction markets. A unified API for trading on Polymarket, Kalshi, and more.
* [Oracle3](https://github.com/YichengYang-Ethan/oracle3) ⭐ 257 | 🐛 18 | 🌐 Python | 📅 2026-05-08 - `Python` - Autonomous trading agent for Kalshi, Polymarket, and Solana — Wang Transform pricing (calibrated on 291k resolved contracts) drives eight constraint-based arbitrage strategies and Kelly-sized model trades.
* [Live Tennis API](https://livetennisapi.com) - `REST` `WebSocket` `MCP` - Real-time tennis scores, serving and break-point state, and model win probabilities for pricing tennis event markets, plus H2H, rankings and a 1968-2022 point-by-point archive; free tier. [GitHub](https://github.com/livetennisapi/livetennisapi-mcp) ⭐ 152 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-20
* [polymm](https://github.com/kachence/polymm) ⭐ 100 | 🐛 1 | 🌐 Python | 📅 2026-08-16 - `Python` `Polymarket` - Market-making and arbitrage bot for Polymarket sports and esports markets, pricing from de-vigged sportsbook odds.
...
* [marketlens](https://github.com/marketlenstrade/marketlens-python) ⭐ 28 | 🐛 0 | 🌐 Python | 📅 2026-09-24 - `Python` `MCP` - Tick-level Polymarket order book history with replay and a backtesting engine simulating queue priority, latency, and slippage.
...
* [outcometick](https://outcometick.com) - `Python` `JavaScript` - Tick-level history for Polymarket and Predict.fun crypto Up/Down markets, including the full-precision Chainlink settlement feeds and each market's strike and settled outcome, with a sandboxed runner that replays a submitted strategy against the same archive. [GitHub](https://github.com/outcometick/outcometick-sdk-ts) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-24

## Calendars & Market Hours

* [pandas\_market\_calendars](https://github.com/rsheftel/pandas_market_calendars) ⭐ 999 | 🐛 22 | 🌐 Python | 📅 2026-07-12 - `Python` - Exchange calendars to use with pandas for trading applications.
* [exchange\_calendars](https://github.com/gerrymanoim/exchange_calendars) ⭐ 668 | 🐛 28 | 🌐 Python | 📅 2026-09-24 - `Python` - Stock Exchange Trading Calendars.
...
* [D-Tale](https://github.com/man-group/dtale) ⭐ 5,221 | 🐛 71 | 🌐 TypeScript | 📅 2026-07-24 - `Python` - Visualizer for pandas dataframes and xarray datasets.
* [mplfinance](https://github.com/matplotlib/mplfinance) ⭐ 4,434 | 🐛 177 | 🌐 Python | 📅 2024-08-08 - `Python` - matplotlib utilities for the visualization, and visual analysis, of financial data.
* [finvizfinance](https://github.com/lit26/finvizfinance) ⭐ 1,712 | 🐛 3 | 🌐 Python | 📅 2026-08-29 - `Python` - Finviz analysis python library.
* [finplot](https://github.com/highfestiva/finplot) ⭐ 1,183 | 🐛 36 | 🌐 Python | 📅 2026-09-24 - `Python` - Performant and effortless finance plotting for Python.
* [dxcharts-lite](https://github.com/devexperts/dxcharts-lite) ⭐ 101 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-22 - `JavaScript` - Flexible financial charting library based on HTML5 canvas.
* [market-analy](https://github.com/maread99/market_analy) ⭐ 80 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - `Python` - Analysis and interactive charting using [market-prices](https://github.com/maread99/market_prices) ⭐ 106 | 🐛 10 | 🌐 Python | 📅 2026-09-15 and bqplot.
...
* [xlsxwriter](https://xlsxwriter.readthedocs.io/) - `Python` - Write files in the Excel 2007+ XLSX file format. [GitHub](https://github.com/jmcnamara/XlsxWriter) ⭐ 3,977 | 🐛 30 | 🌐 Python | 📅 2026-08-04
* [xlwings](https://www.xlwings.org/) - `Python` - Make Excel fly with Python. [GitHub](https://github.com/xlwings/xlwings) ⭐ 3,412 | 🐛 385 | 🌐 Python | 📅 2026-09-26
...
* [Bilig](https://github.com/proompteng/bilig) ⭐ 35 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - `TypeScript` - Formula WorkPaper and XLSX recalculation runtime for Node.js services and agent tools.
...
* [TradingAgents](https://github.com/TauricResearch/TradingAgents) ⭐ 108,702 | 🐛 75 | 🌐 Python | 📅 2026-09-25 - `Python` `LLM` - Multi-agent financial research framework combining fundamental, technical, news, and sentiment analysis with structured investment debates and risk assessment.
* [Jupyter Quant](https://github.com/quantbelt/jupyter-quant) ⭐ 247 | 🐛 9 | 🌐 Shell | 📅 2026-09-25 - `Python` - A dockerized Jupyter quant research environment with preloaded tools for quant analysis, statsmodels, pymc, arch, py\_vollib, zipline-reloaded, PyPortfolioOpt, etc.
* [dsh-quant](https://github.com/pengpengyi92/dsh-quant) ⭐ 43 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-25 - `TypeScript` `DeepSeek Harness` - Agent-native quantitative research toolkit for DeepSeek Harness: 46 tools across data, alpha, ML, risk, execution and ecosystem domains, with an end-to-end research pipeline.
...
* [QFO Quant Platform](https://www.qfo-quant-platform.com/) - `Python` `React` `A-shares` - Local-first quantitative research and backtesting platform with data synchronization, multi-asset screening, factor analysis, portfolio optimization, risk analysis, and optional LLM-assisted news analysis. [GitHub](https://github.com/yeh2017/QFO-Quant-Platform) ⭐ 13 | 🐛 2 | 🌐 Python | 📅 2026-09-24

## Cross-Language Frameworks

* [QuantLib](https://github.com/lballabio/QuantLib) ⭐ 7,635 | 🐛 42 | 🌐 C++ | 📅 2026-09-25 - The QuantLib project is aimed at providing a comprehensive software framework for quantitative finance.
  * [PyQL](https://github.com/enthought/pyql) ⭐ 1,339 | 🐛 20 | 🌐 Cython | 📅 2026-07-17 - Python port.
  * XAD - Automatic Differentiation (AAD) Library in [Python](https://pypi.org/project/xad/) and [C++](https://github.com/auto-differentiation/xad/) ⭐ 430 | 🐛 4 | 🌐 C++ | 📅 2026-09-08
  * [QLNet](https://github.com/amaggiulli/qlnet) ⭐ 428 | 🐛 2 | 🌐 C# | 📅 2026-09-11 - .Net port.
...
* [TA-Lib](https://ta-lib.org) - perform technical analysis of financial market data. [GitHub](https://github.com/TA-Lib/ta-lib) ⭐ 1,681 | 🐛 14 | 🌐 Java | 📅 2026-09-26
  * [ta-lib-python](https://github.com/TA-Lib/ta-lib-python) ⭐ 12,255 | 🐛 134 | 🌐 Cython | 📅 2026-09-21
  * [ta-lib](https://github.com/TA-Lib/ta-lib) ⭐ 1,681 | 🐛 14 | 🌐 Java | 📅 2026-09-26
* [PineTS](https://github.com/LuxAlgo/PineTS) ⭐ 695 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-25 - `TypeScript` `JavaScript` `Pine Script` - Open-source transpiler and runtime that executes Pine Script logic in Node.js and the browser with 1:1 syntax compatibility, for running indicators and strategies on your own infrastructure.
* [XAD](https://github.com/auto-differentiation/xad) ⭐ 430 | 🐛 4 | 🌐 C++ | 📅 2026-09-08 - Automatic Differentation (AAD) Library.
* [godzilla.dev](https://godzilla.dev) - `C++` `Python` - Open-source framework for crypto quant trading, funding rate arbitrage and ultra-low-latency market making. [GitHub](https://github.com/godzilla-foundation/godzilla-community) ⭐ 375 | 🐛 2 | 🌐 C++ | 📅 2026-08-11
* [RunMat](https://runmat.com/) - `Rust` - Runtime for MATLAB-syntax array math with automatic CPU/GPU execution and fused kernels for quantitative simulations. [GitHub](https://github.com/runmat-org/runmat) ⭐ 257 | 🐛 25 | 🌐 Rust | 📅 2026-09-25
* [QuantLibAAD](https://github.com/auto-differentiation/QuantLibAAD) ⭐ 42 | 🐛 2 | 🌐 C++ | 📅 2026-06-12 - Fast risks with QuantLib in C++.

## Reproducing Works, Training & Books

* [python-training](https://github.com/jpmorganchase/python-training) ⭐ 14,123 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-24 - J.P. Morgan's Python training for business analysts and traders.
* [Finance](https://github.com/shashankvemuri/Finance) ⭐ 4,291 | 🐛 3 | 🌐 Python | 📅 2026-09-12 - 150+ quantitative finance Python programs to help you gather, manipulate, and analyze stock market data.
* [algorithmic-trading-with-python](https://github.com/chrisconlan/algorithmic-trading-with-python) ⭐ 3,488 | 🐛 6 | 🌐 Python | 📅 2021-06-01 - Source code for Algorithmic Trading with Python (2020) by Chris Conlan.
* [ML\_Finance\_Codes](https://github.com/mfrdixon/ML_Finance_Codes) ⭐ 2,667 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2020-06-13 - Machine Learning in Finance: From Theory to Practice Book.
...
* [Stock\_Analysis\_For\_Quant](https://github.com/LastAncientOne/Stock_Analysis_For_Quant) ⭐ 2,063 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2025-05-04 - Different Types of Stock Analysis in Excel, Matlab, Power BI, Python, R, and Tableau.
* [volatility-trading](https://github.com/jasonstrimpel/volatility-trading) ⭐ 1,956 | 🐛 4 | 🌐 Python | 📅 2024-10-21 - A complete set of volatility estimators based on Euan Sinclair's Volatility Trading.
* [Hands-On Machine Learning for Algorithmic Trading](https://github.com/packtpublishing/hands-on-machine-learning-for-algorithmic-trading) ⭐ 1,929 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2023-01-18 - Hands-On Machine Learning for Algorithmic Trading, published by Packt.
* [Deep Learning Machine Learning Stock](https://github.com/LastAncientOne/Deep_Learning_Machine_Learning_Stock) ⭐ 1,786 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2024-03-01 - Deep Learning and Machine Learning stocks represent a promising long-term or short-term opportunity for investors and traders.
...
* [fecon235](https://github.com/rsvp/fecon235) ⭐ 1,279 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2023-01-20 - Open source project for software tools in financial economics. Many jupyter notebook to verify theoretical ideas and practical methods interactively.
* [QuantFinanceBook](https://github.com/LechGrzelak/QuantFinanceBook) ⭐ 977 | 🐛 3 | 🌐 Python | 📅 2025-04-14 - Quantitative Finance book.
* [Computational-Finance-Course](https://github.com/LechGrzelak/Computational-Finance-Course) ⭐ 915 | 🐛 0 | 🌐 Python | 📅 2024-03-01 - Materials for the course of Computational Finance.
...
* [py4at](https://github.com/yhilpisch/py4at) ⭐ 857 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2023-10-09 - Jupyter Notebooks and code for the book Python for Algorithmic Trading (O'Reilly) by Yves Hilpisch.
...
* [FinanceHub](https://github.com/Finance-Hub/FinanceHub) ⭐ 802 | 🐛 4 | 🌐 Python | 📅 2024-05-28 - Resources for Quantitative Finance.
...
* [dx](https://github.com/yhilpisch/dx) ⭐ 766 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2025-04-05 - DX Analytics | Financial and Derivatives Analytics with Python.
* [Machine-Learning-for-Asset-Managers](https://github.com/emoen/Machine-Learning-for-Asset-Managers) ⭐ 673 | 🐛 2 | 🌐 Python | 📅 2026-02-11 - Implementation of code snippets, exercises and application to live data from Machine Learning for Asset Managers (Elements in Quantitative Finance) written by Prof. Marcos López de Prado.
* [dawp](https://github.com/yhilpisch/dawp) ⭐ 639 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-02-22 - Jupyter Notebooks and code for Derivatives Analytics with Python (Wiley Finance) by Yves Hilpisch.
...
* [systematictradingexamples](https://github.com/robcarver17/systematictradingexamples) ⭐ 489 | 🐛 0 | 🌐 Python | 📅 2020-07-22 - `Python` - Code examples for Robert Carver's [Systematic Trading](https://www.harriman-house.com/authors/robert-carver/systematic-trading/9780857194459).
* [quant](https://github.com/paulperry/quant) ⭐ 457 | 🐛 0 | 🌐 Python | 📅 2015-07-14 - Quantitative Finance and Algorithmic Trading exhaust; mostly ipython notebooks based on Quantopian, Zipline, or Pandas.
* [Goldman Sachs Quantitative Strategies Research Notes](https://github.com/s0ap/gs-quantitative-strategies-research-notes) ⭐ 445 | 🐛 0 | 📅 2025-11-17 - `Papers` `Derivatives` - Collection of 1990s research papers on derivatives pricing, volatility modeling, hedging, and model risk.
* [aiif](https://github.com/yhilpisch/aiif) ⭐ 400 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-01-14 - Jupyter Notebooks and code for the book Artificial Intelligence in Finance (O'Reilly) by Yves Hilpisch.
...
* [Autoencoder-Asset-Pricing-Models](https://github.com/RichardS0268/Autoencoder-Asset-Pricing-Models) ⭐ 153 | 🐛 2 | 🌐 Python | 📅 2025-08-17 - Reimplementation of Autoencoder Asset Pricing Models ([GKX, 2019](https://www.aqr.com/Insights/Research/Working-Paper/Autoencoder-Asset-Pricing-Models)).
...
* [book\_irds3](https://github.com/attack68/book_irds3) ⭐ 126 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2022-10-29 - Code repository for Pricing and Trading Interest Rate Derivatives.
...
* [RoughVolatilityWorkshop](https://github.com/jgatheral/RoughVolatilityWorkshop) ⭐ 75 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2025-09-06 - 2024 QuantMind's Rough Volatility Workshop lectures.
...
* [frh-fx](https://github.com/rmcrkd/frh-fx) ⭐ 15 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2018-05-24 - A python implementation of the fast-reversion Heston model of Mechkov for FX purposes.
* [Special-Relativity-in-Financial-Modeling](https://github.com/Mattbusel/Special-Relativity-in-Financial-Modeling) ⭐ 14 | 🐛 0 | 🌐 C++ | 📅 2026-09-25 - C++20 implementation of special-relativistic geometry applied to OHLCV data: Lorentz factors, spacetime intervals, Christoffel symbols, and geodesic deviation signals from live market data. DOI: 10.5281/zenodo.18639919.
...
* [TradeMux Snippets](https://github.com/KVignesh122/trademux-examples) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-06-05 - `Python` - Code snippets for Metatrader (MT5) forex/CFD trading and data retrieval via trademux API client.
...
* [Massive](https://massive.com/) - Financial market data API with a permanent free personal-use tier offering two years of US stock history, end-of-day prices, and reference data at five requests per minute, with no credit card required. [GitHub](https://github.com/massive-com/client-python) ⭐ 1,512 | 🐛 25 | 🌐 Python | 📅 2026-07-09

* [London Strategic Edge](https://londonstrategicedge.com/data/) - `Python` - Free market and economic data with up to 10 databank downloads per hour of one million rows each, subject to a shared monthly bandwidth allowance, without a credit card. [GitHub](https://github.com/londonstrategicedge/lse-data) ⭐ 261 | 🐛 7 | 🌐 Python | 📅 2026-08-02

* [Financial Data](https://financialdata.net/) - Financial data API with a free personal-use plan allowing 300 requests per day for symbol lists and selected market data, including historical commodity and OTC prices. [GitHub](https://github.com/financialdatanet/fdnpy) ⭐ 54 | 🐛 0 | 🌐 Python | 📅 2026-09-08

* [Trends MCP](https://www.trendsmcp.ai/) - `MCP` `REST` - Search, social, commerce, and news-sentiment data for alternative-data research, with a permanent free tier of 100 requests/month, 90 days of history, and top-10 trend boards delayed 24 hours. [GitHub](https://github.com/trendsmcp-ai/Trends-MCP) ⭐ 43 | 🐛 3 | 🌐 Python | 📅 2026-08-29
...
* [DexPaprika](https://dexpaprika.com/) - `Python` - DEX pool, token and OHLCV data API with 50,000 free monthly credits without signup and up to 60-second data delays. [GitHub](https://github.com/coinpaprika/dexpaprika-sdk-python) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-09-25
...
* [0xArchive](https://0xarchive.io) - Hyperliquid and Lighter market data through REST, WebSocket and replay, with a permanent free tier offering 50,000 credits per month, 15 requests per second and the most recent 30 days of history without a credit card. [GitHub](https://github.com/0xArchiveIO/sdk-python) ⭐ 8 | 🐛 2 | 🌐 Python | 📅 2026-09-26

* [Korea Stock Data](https://aikstockdata.com/) - `Data` - Free Korean equity settled closes with 250 trading days of per-stock history, DART filings and earnings as JSON/CSV, without signup, an API key or request quotas. [GitHub](https://github.com/na77tech-creator/aikstockdata) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-22

* [PreReason](https://www.prereason.com) - `JavaScript` - Bitcoin and macroeconomic market briefings through REST and MCP, with a permanent free tier of six briefings, 30-day history, 60 requests per hour and 500 per day, without a credit card. [GitHub](https://github.com/PreReason/mcp) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-22
...
* [brapi.dev](https://brapi.dev/) - Brazilian market data API with a free tier of 15,000 requests per month and up to three months of price history, plus four stocks accessible without an account. [GitHub](https://github.com/brapi-dev/brapi-python) ⭐ 2 | 🐛 1 | 🌐 Python | 📅 2026-09-23
...
* [SiftingIO](https://sifting.io) - `Python` - Market data over REST and WebSocket with a permanent free non-commercial tier per market: 10,000 monthly REST calls, 60 requests per minute, five streaming symbols and one month of history, without a credit card. [GitHub](https://github.com/SiftingIO/sdk-python) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-02

* [Tessera](https://tesseralytics.dev) - `Python` - Hyperliquid order-flow-enriched minute OHLCV with a permanent free tier covering BTC, ETH, SOL and HYPE over the trailing month, with unlimited Parquet downloads and no credit card. [GitHub](https://github.com/tesseralytics/python-client) ⭐ 2 | 🐛 2 | 🌐 Python | 📅 2026-09-21
...
* [Korean Market Data](https://kexportstars.com/tools/) - `Data` - Free Korean investor-flow and sector-index datasets in English CSV/JSON, updated each trading day under CC BY 4.0 without signup. [GitHub](https://github.com/james-brand/korea-market-data) ⭐ 0 | 🐛 0 | 📅 2026-09-26

* [FillBench](https://fillbench.com) - Free crypto-exchange API latency benchmarks with p50/p95/p99 measurements, separate TLS timing and downloadable CC BY datasets. [GitHub](https://github.com/sircharli3/fillbench-data) ⭐ 0 | 🐛 2 | 🌐 Python | 📅 2026-09-26
...
* [GitDealFlow](https://gitdealflow.com) - Alternative-data research on private companies using GitHub commit velocity and contributor growth, with a permanently free weekly digest covering five startups and basic MCP read tools. [GitHub](https://github.com/kindrat86/vc-deal-flow-signal) ⭐ 0 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-24
...
* [AtlasYield](https://atlasyield.club) - DeFi vault scores across 16 factors, with a free read-only API requiring no signup and limited to 60 requests per minute per IP. [GitHub](https://github.com/gveshk/atlasyield-score-history) ⭐ 0 | 🐛 0 | 📅 2026-09-26
...
* [fooltrader](https://github.com/foolcage/fooltrader) ⭐ 1,199 | 🐛 6 | 🌐 Python | 📅 2023-05-22 - `Python` `Historical` - Archived big-data quantitative-analysis and trading system retained as an early unified market-data and backtesting framework.
...
* [awesome-sec-filings](https://github.com/vibeyclaw/awesome-sec-filings) ⭐ 40 | 🐛 11 | 📅 2026-07-04 - A curated list of tools, data sources, libraries, and resources for working with SEC filings (13F, 10-K, 10-Q, 8-K).
