...
* [pandas](https://pandas.pydata.org) - `Python` - pandas is an open source, BSD-licensed library providing high-performance, easy-to-use data structures and data analysis tools for the Python programming language. [GitHub](https://github.com/pandas-dev/pandas) ⭐ 49,515 | 🐛 2,848 | 🌐 Python | 📅 2026-08-13
* [polars](https://docs.pola.rs/) - `Python` - Polars is a blazingly fast DataFrame library for manipulating structured data. [GitHub](https://github.com/pola-rs/polars) ⭐ 39,343 | 🐛 2,840 | 🌐 Rust | 📅 2026-08-13
* [numpy](https://www.numpy.org) - `Python` - NumPy is the fundamental package for scientific computing with Python. [GitHub](https://github.com/numpy/numpy) ⭐ 32,530 | 🐛 2,326 | 🌐 Python | 📅 2026-08-12
* [scipy](https://www.scipy.org) - `Python` - SciPy (pronounced “Sigh Pie”) is a Python-based ecosystem of open-source software for mathematics, science, and engineering. [GitHub](https://github.com/scipy/scipy) ⭐ 14,911 | 🐛 1,849 | 🌐 Python | 📅 2026-08-12
* [sympy](https://www.sympy.org/) - `Python` - SymPy is a Python library for symbolic mathematics. [GitHub](https://github.com/sympy/sympy) ⭐ 14,858 | 🐛 5,932 | 🌐 Python | 📅 2026-08-12
* [pymc3](https://docs.pymc.io/) - `Python` - Probabilistic Programming in Python: Bayesian Modeling and Probabilistic Machine Learning with Theano. [GitHub](https://github.com/pymc-devs/pymc) ⭐ 9,705 | 🐛 477 | 🌐 Python | 📅 2026-08-12
* [data.table](https://github.com/Rdatatable/data.table) ⭐ 3,908 | 🐛 982 | 🌐 R | 📅 2026-08-11 - `R` - Extension of data.frame: Fast aggregation of large data (e.g. 100GB in RAM), fast ordered joins, fast add/modify/delete of columns by group using no copies at all, list columns and a fast file reader (fread). Offers a natural and flexible syntax, for faster development.
* [ArcticDB](https://github.com/man-group/ArcticDB) ⭐ 2,457 | 🐛 318 | 🌐 C++ | 📅 2026-08-13 - `Python` - High performance datastore for time series and tick data.
...
* [modelx](https://docs.modelx.io/) - `Python` - Python reimagination of spreadsheets as formula-centric objects that are interoperable with pandas. [GitHub](https://github.com/fumitoh/modelx) ⭐ 133 | 🐛 36 | 🌐 Python | 📅 2026-08-08
...
* [gs-quant](https://github.com/goldmansachs/gs-quant) ⭐ 11,967 | 🐛 63 | 🌐 Python | 📅 2026-08-06 - `Python` - Python toolkit for quantitative finance.
* [tf-quant-finance](https://github.com/google/tf-quant-finance) ⭐ 5,471 | 🐛 41 | 🌐 Python | 📅 2026-08-06 - `Python` - High-performance TensorFlow library for quantitative finance.
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 3,105 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-08-10 - `Python` - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
* [ffn](https://github.com/pmorissette/ffn) ⭐ 2,633 | 🐛 5 | 🌐 Python | 📅 2026-08-12 - `Python` - A financial function library for Python.
* [RustQuant](https://github.com/avhz/RustQuant) ⭐ 1,793 | 🐛 35 | 🌐 Rust | 📅 2026-01-14 - `Rust` - Quantitative finance library written in Rust.
...
* [PyQL](https://github.com/enthought/pyql) ⭐ 1,334 | 🐛 20 | 🌐 Cython | 📅 2026-07-17 - `Python` - QuantLib's Python port.
...
* [Strata](http://strata.opengamma.io/) - `Java` - Modern open-source analytics and market risk library designed and written in Java. [GitHub](https://github.com/OpenGamma/Strata) ⭐ 955 | 🐛 89 | 🌐 Java | 📅 2026-07-31
* [Finance-Python](https://github.com/alpha-miner/Finance-Python) ⭐ 910 | 🐛 9 | 🌐 Python | 📅 2024-01-01 - `Python` - Python tools for Finance.
...
* [optionlab](https://github.com/rgaveiga/optionlab) ⭐ 558 | 🐛 6 | 🌐 Python | 📅 2026-08-10 - `Python` - A Python library for evaluating option trading strategies.
...
* [quantcomponents](https://github.com/lsgro/quantcomponents) ⭐ 170 | 🐛 4 | 🌐 Java | 📅 2018-07-28 - `Java` - Free Java components for Quantitative Finance and Algorithmic Trading.
...
* [TA-Lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,184 | 🐛 137 | 🌐 Cython | 📅 2026-07-29 - `Python` - Python wrapper for TA-Lib (<http://ta-lib.org/>).
* [ta](https://github.com/bukosabino/ta) ⭐ 5,140 | 🐛 156 | 🌐 Jupyter Notebook | 📅 2026-03-18 - `Python` - Technical Analysis Library using Pandas (Python).
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,479 | 🐛 12 | 🌐 Java | 📅 2026-08-13 - `Java` - A Java library for technical analysis.
...
* [IndicatorGo](https://github.com/cinar/indicator) ⭐ 1,221 | 🐛 35 | 🌐 Go | 📅 2026-08-10 - `Golang` - IndicatorGo is a Golang module providing various stock technical analysis indicators, strategies, and a backtest framework for trading.
...
* [Wickra](https://github.com/wickra-lib/wickra) ⭐ 41 | 🐛 1 | 🌐 Rust | 📅 2026-08-12 - `Rust` `Python` `JavaScript` `C++` `C#` `Golang` `Java` `R` - Streaming-first technical-analysis library with a Rust core: 514 indicators updating in O(1) per tick, with bit-exact batch-vs-streaming results.
...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 53,241 | 🐛 31 | 🌐 Python | 📅 2026-08-13 - `Python` - Free, open source crypto trading bot.

* [Qlib](https://github.com/microsoft/qlib) ⭐ 47,364 | 🐛 473 | 🌐 Python | 📅 2026-07-23 - `Python` - An AI-oriented Quantitative Investment Platform by Microsoft. Full ML pipeline of data processing, model training, back-testing; and covers the entire chain of quantitative investment: alpha seeking, risk modeling, portfolio optimization, and order execution.

* [vnpy](https://github.com/vnpy/vnpy) ⭐ 44,435 | 🐛 29 | 🌐 Python | 📅 2026-08-10 - `Python` - VeighNa is a Python-based open source quantitative trading system development framework.

* [ccxt](https://github.com/ccxt/ccxt) ⭐ 43,614 | 🐛 737 | 🌐 Python | 📅 2026-08-13 - `JavaScript` `Python` `PHP` - A JavaScript / Python / PHP cryptocurrency trading API with support for more than 100 bitcoin/altcoin exchanges.

* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 30,737 | 🐛 24 | 🌐 Python | 📅 2026-08-13 - `Python` - Natural-language multi-agent finance research agent with 29 swarm presets, 70 skills, and 28 auto-discovered tools; 7 backtest engines covering A-shares/US/Crypto/Futures/Forex/Options plus a cross-market CompositeEngine with shared capital pool; 5-source auto-fallback data layer (tushare/okx/yfinance/akshare/ccxt); 17-tool MCP server; includes trade-journal behavioral diagnostics for 同花顺/东财/富途 exports.

* [nautilus\_trader](https://github.com/nautechsystems/nautilus_trader) ⭐ 25,455 | 🐛 101 | 🌐 Rust | 📅 2026-08-13 - `Python` `Rust` - A high-performance algorithmic trading platform and event-driven backtester.

* [backtrader](https://github.com/backtrader/backtrader) ⭐ 22,832 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - `Python` - Python Backtesting library for trading strategies.

* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,190 | 🐛 263 | 🌐 C# | 📅 2026-08-12 - `Python` `C#` - Lean Algorithmic Trading Engine by QuantConnect (Python, C#).

* [QuantConnect](https://github.com/QuantConnect/Lean) ⭐ 21,190 | 🐛 263 | 🌐 C# | 📅 2026-08-12 - `CSharp` - Lean Engine is an open-source fully managed C# algorithmic trading engine built for desktop and cloud usage.

* [machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading) ⭐ 20,433 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-08-13 - `Python` - Code and resources for Machine Learning for Algorithmic Trading.

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,032 | 🐛 369 | 🌐 Python | 📅 2024-02-13 - `Python` - Pythonic algorithmic trading library.

* [FinRL-Library](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 15,998 | 🐛 306 | 🌐 Jupyter Notebook | 📅 2026-07-13 - `Python` - A Deep Reinforcement Learning Library for Automated Trading in Quantitative Finance. NeurIPS 2020.
...
* [StockSharp](https://github.com/StockSharp/StockSharp) ⭐ 10,553 | 🐛 2 | 🌐 C# | 📅 2026-08-10 - `CSharp` - Algorithmic trading and quantitative trading open source platform to develop trading robots (stock markets, forex, crypto, bitcoins, and options).
...
* [vectorbt](https://github.com/polakowo/vectorbt) ⭐ 8,659 | 🐛 136 | 🌐 Python | 📅 2026-08-02 - `Python` - Find your trading edge, using a powerful toolkit for backtesting, algorithmic trading, and research.

* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,315 | 🐛 11 | 🌐 Python | 📅 2026-08-12 - `Python` - An advanced crypto trading bot written in Python.

* [quantstats](https://github.com/ranaroussi/quantstats) ⭐ 7,545 | 🐛 30 | 🌐 Python | 📅 2026-07-20 - `Python` - Portfolio analytics for quants, written in Python.

* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,685 | 🐛 30 | 🌐 Python | 📅 2026-08-10 - `Python` - A extendable, replaceable Python algorithmic backtest && trading framework supporting multiple securities.

* [OctoBot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,384 | 🐛 159 | 🌐 Python | 📅 2026-08-13 - `Python` - Open source cryptocurrency trading bot for high frequency, arbitrage, TA and social trading with an advanced web interface.

* [pyalgotrade](https://github.com/gbeced/pyalgotrade) ⚠️ Archived - `Python` - Python Algorithmic Trading Library.

* [hftbacktest](https://github.com/nkaz001/hftbacktest) ⭐ 4,354 | 🐛 16 | 🌐 Rust | 📅 2025-12-23 - `Python` - A high-frequency trading and market-making backtesting tool accounts for limit orders, queue positions, and latencies, utilizing full tick data for trades and order books.

* [zvt](https://github.com/zvtvz/zvt) ⭐ 4,260 | 🐛 23 | 🌐 Python | 📅 2026-07-01 - `Python` - the project using sql, pandas to provide an uniform and extendable way to record data, computing factors, select securities, backtesting, realtime trading and it could show all of them in clearly charts in realtime.

* [finmarketpy](https://github.com/cuemacro/finmarketpy) ⭐ 3,800 | 🐛 38 | 🌐 Python | 📅 2026-04-16 - `Python` - Python library for backtesting trading strategies and analyzing financial markets.

* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,502 | 🐛 2 | 🌐 Python | 📅 2026-08-11 - `Python` - Algorithmic Trading with Machine Learning.

* [QSTrader](https://github.com/mhallsmoore/qstrader) ⭐ 3,433 | 🐛 18 | 🌐 Python | 📅 2024-06-30 - `Python` - QSTrader backtesting simulation engine.

* [pysystemtrade](https://github.com/robcarver17/pysystemtrade) ⭐ 3,433 | 🐛 31 | 🌐 Python | 📅 2026-07-18 - `Python` - pysystemtrade is the open source version of Robert Carver's backtesting and trading engine that implements systems according to the framework outlined in his book "Systematic Trading", which is further developed on his [blog](https://qoppac.blogspot.com/).

* [Hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,432 | 🐛 5 | 🌐 C++ | 📅 2026-08-12 - `Python` `C++` - A base on Python/C++ open source high-performance quant framework for faster analysis and backtesting, contains the complete trading system components for reuse and combination.

* [Hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,432 | 🐛 5 | 🌐 C++ | 📅 2026-08-12 - `Python` `C++` - A base on Python/C++ open source high-performance quant framework for faster analysis and backtesting, contains the complete trading system components for reuse and combination. You can use python or c++ freely.
...
* [bulbea](https://github.com/achillesrasquinha/bulbea) ⭐ 2,320 | 🐛 37 | 🌐 Python | 📅 2021-01-17 - `Python` - Deep Learning based Python Library for Stock Market Prediction and Modelling.

* [qtpylib](https://github.com/ranaroussi/qtpylib) ⚠️ Archived - `Python` - QTPyLib, Pythonic Algorithmic Trading <http://qtpylib.io>.

* [Barter](https://github.com/barter-rs/barter-rs) ⭐ 2,227 | 🐛 86 | 🌐 Rust | 📅 2026-06-06 - `Rust` - Open-source Rust framework for building event-driven live-trading & backtesting systems.

* [zipline-reloaded](https://github.com/stefan-jansen/zipline-reloaded) ⭐ 1,919 | 🐛 43 | 🌐 Python | 📅 2026-01-06 - `Python` - Zipline, a Pythonic Algorithmic Trading Library.

* [Lumibot](https://github.com/Lumiwealth/lumibot) ⭐ 1,918 | 🐛 87 | 🌐 Python | 📅 2026-08-12 - `Python` - Algorithmic trading framework where the same code runs for backtesting and live trading across stocks, options, crypto, futures, and forex with multiple brokers including Alpaca, Interactive Brokers, Tradier, and Schwab.

* [Intelligent Trading Bot](https://github.com/asavinov/intelligent-trading-bot) ⭐ 1,844 | 🐛 47 | 🌐 Python | 📅 2026-08-11 - `Python` - Automatically generating signals and trading based on machine learning and feature engineering.

* [fastquant](https://github.com/enzoampil/fastquant) ⭐ 1,753 | 🐛 82 | 🌐 Jupyter Notebook | 📅 2023-09-15 - `Python` - fastquant allows you to easily backtest investment strategies with as few as 3 lines of python code.

* [AlphaPy](https://github.com/ScottfreeLLC/AlphaPy) ⭐ 1,744 | 🐛 19 | 🌐 Python | 📅 2025-08-24 - `Python` - Automated Machine Learning \[AutoML] with Python, scikit-learn, Keras, XGBoost, LightGBM, and CatBoost.

* [Investing algorithm framework](https://github.com/coding-kitties/investing-algorithm-framework) ⭐ 1,646 | 🐛 70 | 🌐 Python | 📅 2026-08-10 - `Python` - Framework for developing, backtesting, and deploying automated trading algorithms.
...
* [fooltrader](https://github.com/foolcage/fooltrader) ⭐ 1,199 | 🐛 6 | 🌐 Python | 📅 2023-05-22 - `Python` - the project using big-data technology to provide an uniform way to analyze the whole market.
...
* [PRISM-INSIGHT](https://github.com/dragon1086/prism-insight) ⭐ 719 | 🐛 3 | 🌐 Python | 📅 2026-08-13 - `Python` - AI-powered stock analysis system with 13 specialized agents, automated trading via KIS API, supporting Korean & US markets.

* [pylivetrader](https://github.com/alpacahq/pylivetrader) ⭐ 686 | 🐛 20 | 🌐 Python | 📅 2022-10-04 - `Python` - zipline-compatible live trading library.

* [TradeFrame](https://github.com/rburkholder/trade-frame) ⭐ 671 | 🐛 3 | 🌐 C++ | 📅 2026-03-05 - `CPP` - C++ 17 based framework/library (with sample applications) for testing options based automated trading ideas using DTN IQ real time data feed and Interactive Brokers (TWS API) for trade execution. Comes with built-in [Option Greeks/IV](https://github.com/rburkholder/trade-frame/tree/master/lib/TFOptions) ⭐ 671 | 🐛 3 | 🌐 C++ | 📅 2026-03-05 calculation library.

* [fast-trade](https://github.com/jrmeier/fast-trade) ⭐ 580 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - `Python` - A library built with backtest portability and performance in mind for backtest trading strategies.
...
* [the0](https://github.com/alexanderwanyoike/the0) ⭐ 390 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-12 - `Python` - Self-hosted execution engine for algorithmic trading bots. Write strategies in Python, TypeScript, Rust, C++, C#, Scala, or Haskell and deploy with one command. Each bot runs in an isolated container with scheduled or streaming execution.
...
* [pinkfish](https://github.com/fja05680/pinkfish) ⭐ 301 | 🐛 4 | 🌐 Python | 📅 2026-07-22 - `Python` - A backtester and spreadsheet library for security analysis.
...
* [pipeline-live](https://github.com/alpacahq/pipeline-live) ⭐ 206 | 🐛 15 | 🌐 Python | 📅 2023-07-25 - `Python` - zipline's pipeline capability with IEX for live trading.

* [PyLOB](https://github.com/DrAshBooth/PyLOB) ⭐ 202 | 🐛 4 | 🌐 Python | 📅 2026-08-10 - `Python` - Fully functioning fast Limit Order Book written in Python.
...
* [jquantstats](https://github.com/Jebel-Quant/jquantstats) ⭐ 42 | 🐛 6 | 🌐 Python | 📅 2026-08-13 - `Python` - Modern variation of quantstats, with additional features and performance improvements.

* [DeepAlpha](https://deepalphabot.com) - `Python` - AI crypto trading bot for Bybit with 70.9% walk-forward validated accuracy on out-of-sample data, LightGBM + XGBoost ensemble with 72 ML features. [GitHub](https://github.com/stefanoviana/deepalpha) ⭐ 40 | 🐛 18 | 🌐 Python | 📅 2026-05-12
...
* [aurumq-rl](https://github.com/yupoet/aurumq-rl) ⭐ 38 | 🐛 17 | 🌐 Python | 📅 2026-07-24 - `Python` - Reinforcement learning stock-selection framework for the China A-share market with multi-source factor input (alpha101 + main-force flow + hot-money seats + northbound + institutional + fundamentals), board-aware price limits, and ONNX CPU inference.
...
* [Inalpha](https://github.com/mirror29/inalpha) ⭐ 26 | 🐛 24 | 🌐 Python | 📅 2026-08-10 - `Python` `TypeScript` - Conversational multi-agent quant framework where agents rank currently-effective factors for entry timing (time-series rank IC), write complete strategy code that passes sandboxed audit before backtesting, and evolve strategies under multi-objective fitness; every order requires machine approval and the LLM never has a direct order path.

* [VARRD](https://github.com/augiemazza/varrd) ⭐ 25 | 🐛 0 | 🌐 Python | 📅 2026-05-04 - `Python` - AI-powered trading edge discovery platform that validates trading ideas with event studies, statistical tests, and real market data. Web app, MCP server, CLI (`pip install varrd`), and Python SDK.

* [purgedcv](https://github.com/eslazarev/purged-cross-validation) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-08-01 - `Python` - scikit-learn-compatible purged, group-purged, and combinatorial purged (CPCV) cross-validation, walk-forward splitting, and backtest-overfitting statistics (deflated and probabilistic Sharpe ratios, PBO, minimum backtest length) to prevent leakage and overfitting when backtesting trading strategies.
...
* [income-desk](https://github.com/nitinblue/income-desk) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - `Python` - Systematic options trading intelligence for small accounts with desk-based portfolio management, pre-trade validation, and multi-broker consolidation.
...
* [TraderHarness](https://github.com/HephaestLab/TraderHarness) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - `Python` - Contamination-resistant A-share backtesting environment for LLM trading agents with point-in-time masking, entity/date anonymization, fingerprinted replay, and trajectory (SFT) export.
...
* [VerumTrade](https://github.com/muye1202/VerumTrade) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2026-06-29 - `Python` - A reasoning & decision-trace visible Multi-agent LLM trading-research framework where bull/bear analysts debate each ticker and every decision cites the evidence it rests on.

* [YABTE](https://github.com/bsdz/yabte) ⭐ 7 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-02-15 - `Python` - Yet Another (Python) BackTesting Engine.

* [AlgoVault](https://github.com/AlgoVaultLabs/crypto-quant-signal-mcp) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-13 - `TypeScript` - MCP server returning composite crypto trade verdicts (direction, confidence, regime) across 5 perpetual-futures venues, with cross-venue funding-rate arbitrage and an on-chain Merkle-verified track record. Free tier.
...
* [quantify](https://github.com/Zhanghanser/quantify) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-06-30 - `Python` - Binance-style trading terminal with multi-strategy backtesting and a real-time, signal-only decision desk for crypto, A-shares, and US stocks.
...
* [Ghostfolio](https://github.com/ghostfolio/ghostfolio) ⭐ 9,113 | 🐛 289 | 🌐 TypeScript | 📅 2026-08-12 - `JavaScript` - Wealth management software to keep track of financial assets like stocks, ETFs or cryptocurrencies and make solid, data-driven investment decisions.
* [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,393 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 - `Python` - Portfolio and risk analytics in Python.
* [PyPortfolioOpt](https://github.com/robertmartin8/PyPortfolioOpt) ⭐ 5,955 | 🐛 112 | 🌐 Jupyter Notebook | 📅 2026-07-07 - `Python` - Financial portfolio optimization in python, including classical efficient frontier and advanced methods.
...
* [Riskfolio-Lib](https://github.com/dcajasn/Riskfolio-Lib) ⭐ 4,440 | 🐛 6 | 🌐 C++ | 📅 2026-06-22 - `Python` - Portfolio Optimization and Quantitative Strategic Asset Allocation in Python.
...
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 2,091 | 🐛 24 | 🌐 Python | 📅 2026-07-31 - `Python` - Python library for portfolio optimization built on top of scikit-learn. It provides a unified interface and sklearn compatible tools to build, tune and cross-validate portfolio models.
...
* [fecon235](https://github.com/rsvp/fecon235) ⭐ 1,273 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2023-01-20 - `Python` - Computational tools for financial economics include: Gaussian Mixture model of leptokurtotic risk, adaptive Boltzmann portfolios.
...
* [pyfolio-reloaded](https://github.com/stefan-jansen/pyfolio-reloaded) ⭐ 604 | 🐛 15 | 🌐 Jupyter Notebook | 📅 2025-12-15 - `Python` - Portfolio and risk analytics in Python. [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,393 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 fork.
...
* [fortitudo.tech](https://github.com/fortitudo-tech/fortitudo.tech) ⭐ 303 | 🐛 1 | 🌐 Python | 📅 2026-07-09 - `Python` - Conditional Value-at-Risk (CVaR) portfolio optimization and Entropy Pooling views / stress-testing in Python.
...
* [riskParityPortfolio](https://github.com/dppalomar/riskParityPortfolio) ⭐ 123 | 🐛 9 | 🌐 R | 📅 2022-11-15 - `R` - Blazingly fast design of risk parity portfolios.
...
* [OptimalPortfolios](https://github.com/ArturSepp/OptimalPortfolios) ⭐ 86 | 🐛 3 | 🌐 Python | 📅 2026-08-13 - `Python` - Optimisation analytics for constructing and backtesting optimal multi-asset portfolios: covariance estimation, rolling optimisation, and performance reporting in one pipeline.
...
* [alphalens](https://github.com/quantopian/alphalens) ⭐ 4,409 | 🐛 51 | 🌐 Jupyter Notebook | 📅 2024-02-12 - `Python` - Performance analysis of predictive alpha factors.
...
* [alphalens-reloaded](https://github.com/stefan-jansen/alphalens-reloaded) ⭐ 625 | 🐛 13 | 🌐 Python | 📅 2025-12-15 - `Python` - Performance analysis of predictive (alpha) stock factors.
* [QuantGPT](https://github.com/Miasyster/QuantGPT) ⭐ 435 | 🐛 3 | 🌐 Python | 📅 2026-05-20 - `Python` - Agent-driven A-share factor research engine with 8 MCP tools covering hypothesis design, backtesting, scoring, and anti-overfit detection.
...
* [Alpha Skills](https://github.com/VernonOY/alpha-skills) ⭐ 79 | 🐛 0 | 📅 2026-04-14 - `Python` - AI skills for quantitative factor research: discover, evaluate, mine, backtest, and monitor factors through any AI coding assistant. Supports A-share, HK, and US markets.
* [ml-quant-trading](https://github.com/initial-d/ml-quant-trading) ⭐ 69 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - `Python` - PyTorch research stack for multi-factor analysis, bias correction, portfolio optimization, and reproducible backtesting.
...
* [Facebook Prophet](https://github.com/facebook/prophet) ⭐ 20,352 | 🐛 454 | 🌐 Python | 📅 2026-08-08 - `Python` - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
* [statsmodels](http://statsmodels.sourceforge.net) - `Python` - Python module that allows users to explore data, estimate statistical models, and perform statistical tests. [GitHub](https://github.com/statsmodels/statsmodels) ⭐ 11,568 | 🐛 2,831 | 🌐 Python | 📅 2026-08-12
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,284 | 🐛 71 | 🌐 Jupyter Notebook | 📅 2026-07-06 - `Python` - Automatic extraction of relevant features from time series.
* [gluon-ts](https://github.com/awslabs/gluon-ts) ⭐ 5,224 | 🐛 473 | 🌐 Python | 📅 2026-07-31 - `Python` - vProbabilistic time series modeling in Python.
...
* [OpenBB Terminal](https://github.com/OpenBB-finance/OpenBBTerminal) ⭐ 71,820 | 🐛 107 | 🌐 Python | 📅 2026-07-30 - `Python` - Terminal for investment research for everyone.
* [Fincept Terminal](https://github.com/Fincept-Corporation/FinceptTerminal) ⭐ 30,164 | 🐛 10 | 🌐 C++ | 📅 2026-08-11 - `Python` - Advance Data Based A.I Terminal for all Types of Financial Asset Research.
* [yfinance](https://github.com/ranaroussi/yfinance) ⭐ 24,977 | 🐛 169 | 🌐 Python | 📅 2026-08-12 - `Python` - Yahoo! Finance market data downloader (+faster Pandas Datareader).
* [akshare](https://github.com/jindaxiang/akshare) ⭐ 21,995 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - `Python` - AkShare is an elegant and simple financial data interface library for Python, built for human beings! <https://akshare.readthedocs.io>.
* [FinanceDatabase](https://github.com/JerBouma/FinanceDatabase) ⭐ 8,329 | 🐛 6 | 🌐 Python | 📅 2026-08-09 - `Python` - This is a database of 300.000+ symbols containing Equities, ETFs, Funds, Indices, Currencies, Cryptocurrencies and Money Markets.
* [FinanceToolkit](https://github.com/JerBouma/FinanceToolkit) ⭐ 5,219 | 🐛 5 | 🌐 Python | 📅 2026-08-13 - `Python` - Toolkit with 200+ financial metrics including 80+ financial ratios, 30+ technical indicators, 20+ risk and performance metrics and 50+ macro indicators which pulls from Financial Modeling Prep, Yahoo Finance, OECD, GMBD and more.
* [alpha\_vantage](https://github.com/RomelTorres/alpha_vantage) ⭐ 4,894 | 🐛 3 | 🌐 Python | 📅 2026-07-26 - `Python` - A python wrapper for Alpha Vantage API for financial data.
* [pandas-datareader](https://github.com/pydata/pandas-datareader) ⭐ 3,229 | 🐛 146 | 🌐 Python | 📅 2026-07-21 - `Python` - Python module to get data from various sources (Google Finance, Yahoo Finance, FRED, OECD, Fama/French, World Bank, Eurostat...) into Pandas datastructures such as DataFrame, Panel with a caching mechanism.
* [edgartools](https://github.com/dgunning/edgartools) ⭐ 2,577 | 🐛 22 | 🌐 Python | 📅 2026-08-13 - `Python` - AI-native SEC EDGAR library with XBRL financials, clean text extraction, 17+ typed forms, and pandas DataFrames.
* [findatapy](https://github.com/cuemacro/findatapy) ⭐ 2,100 | 🐛 28 | 🌐 Python | 📅 2026-07-02 - `Python` - Python library to download market data via Bloomberg, Quandl, Yahoo etc.
...
* [defeatbeta-api](https://github.com/defeat-beta/defeatbeta-api) ⭐ 724 | 🐛 4 | 🌐 Python | 📅 2026-08-06 - `Python` - An open-source alternative to Yahoo Finance's market data APIs with higher reliability.
...
* [datamule-python](https://github.com/john-friedman/datamule-python) ⭐ 552 | 🐛 15 | 🌐 Python | 📅 2026-07-27 - `Python` - A package to work with SEC data. Incorporates datamule endpoints.
...
* [Trading Strategy](https://github.com/tradingstrategy-ai/trading-strategy/) ⭐ 375 | 🐛 11 | 🌐 Python | 📅 2026-08-10 - `Python` - download price data for decentralised exchanges and lending protocols (DeFi).
...
* [tardis-python](https://github.com/tardis-dev/tardis-python) ⭐ 146 | 🐛 0 | 🌐 Python | 📅 2026-08-04 - `Python` - Python interface for Tardis.dev high frequency crypto market data.
...
* [market-prices](https://github.com/maread99/market_prices) ⭐ 104 | 🐛 10 | 🌐 Python | 📅 2026-07-23 - `Python` - Create meaningful OHLCV datasets from knowledge of [exchange-calendars](https://github.com/gerrymanoim/exchange_calendars) ⭐ 662 | 🐛 29 | 🌐 Python | 📅 2026-07-31 (works out-the-box with data from Yahoo Finance).
...
* [SwapAPI](https://swapapi.dev) - `Python` - Free DEX aggregator API returning executable swap calldata across 46 EVM chains. No API key required. [GitHub](https://github.com/swap-api/swap-api) ⭐ 22 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-03
...
* [edinet-mcp](https://github.com/ajtgjmdjp/edinet-mcp) ⭐ 16 | 🐛 6 | 🌐 Python | 📅 2026-07-27 - `Python` - Parse Japanese XBRL financial statements from EDINET with 161 normalized labels, 26 financial metrics, and multi-company screening.
* [dexpaprika-sdk-python](https://github.com/coinpaprika/dexpaprika-sdk-python) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-08-07 - `Python` - Free DEX data API client. 34 blockchains, 30M+ pools, 27M+ tokens, real-time SSE streaming, OHLCV. No API key needed.
...
* [Korea Stock Data](https://github.com/na77tech-creator/korea-stock-data) ⭐ 0 | 🐛 1 | 📅 2026-07-19 - `Data` - Free daily dataset of top KOSPI/KOSDAQ stocks by market cap: prices, fundamentals, and analyst consensus estimates in CSV/JSON, updated every trading day, LLM/AI-readable.
...
* [FillBench](https://fillbench.com) - Reproducible crypto exchange REST API latency benchmarks (p50/p95/p99 and TLS connect time) measured every 2 hours from a fixed US East server. Raw data: [GitHub](https://github.com/sircharli3/fillbench-data) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-08-13.
...
* [pmxt](https://github.com/pmxt-dev/pmxt) ⭐ 2,075 | 🐛 1,061 | 🌐 TypeScript | 📅 2026-07-18 - `Python` `JavaScript` - The CCXT for prediction markets. A unified API for trading on Polymarket, Kalshi, and more.
* [Oracle3](https://github.com/YichengYang-Ethan/oracle3) ⭐ 255 | 🐛 17 | 🌐 Python | 📅 2026-05-08 - `Python` - Autonomous trading agent for Kalshi, Polymarket, and Solana — Wang Transform pricing (calibrated on 291k resolved contracts) drives eight constraint-based arbitrage strategies and Kelly-sized model trades.
...
* [prediction-market-maker](https://github.com/octavi42/prediction-market-maker) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-04-10 - `Python` - Open-source market-making strategy that placed #2 in Paradigm's prediction market challenge, with full strategy evolution and analysis.
...
* [exchange\_calendars](https://github.com/gerrymanoim/exchange_calendars) ⭐ 662 | 🐛 29 | 🌐 Python | 📅 2026-07-31 - `Python` - Stock Exchange Trading Calendars.
...
* [finvizfinance](https://github.com/lit26/finvizfinance) ⭐ 1,551 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-01-03 - `Python` - Finviz analysis python library.
...
* [QuantInvestStrats](https://github.com/ArturSepp/QuantInvestStrats) ⭐ 601 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - `Python` - Quantitative Investment Strategies (QIS) package implements Python analytics for visualisation of financial data, performance reporting, analysis of quantitative strategies.
* [dxcharts-lite](https://github.com/devexperts/dxcharts-lite) ⭐ 101 | 🐛 11 | 🌐 TypeScript | 📅 2026-07-08 - `JavaScript` - Flexible financial charting library based on HTML5 canvas.
* [market-analy](https://github.com/maread99/market_analy) ⭐ 80 | 🐛 2 | 🌐 Python | 📅 2026-07-23 - `Python` - Analysis and interactive charting using [market-prices](https://github.com/maread99/market_prices) ⭐ 104 | 🐛 10 | 🌐 Python | 📅 2026-07-23 and bqplot.
...
* [Exeria Charts](https://github.com/efixdata/exeria-charts) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-19 - `JavaScript` - High-performance, native Canvas/WebGL financial charting library for self-hosted applications without iframe limits.
...
* [xlwings](https://www.xlwings.org/) - `Python` - Make Excel fly with Python. [GitHub](https://github.com/xlwings/xlwings) ⭐ 3,393 | 🐛 406 | 🌐 Python | 📅 2026-08-10
...
* [QuantLib](https://github.com/lballabio/QuantLib) ⭐ 7,507 | 🐛 47 | 🌐 C++ | 📅 2026-08-13 - The QuantLib project is aimed at providing a comprehensive software framework for quantitative finance.
  * [PyQL](https://github.com/enthought/pyql) ⭐ 1,334 | 🐛 20 | 🌐 Cython | 📅 2026-07-17 - Python port.
  * [QLNet](https://github.com/amaggiulli/qlnet) ⭐ 427 | 🐛 5 | 🌐 C# | 📅 2026-08-04 - .Net port.
...
* [TA-Lib](https://ta-lib.org) - perform technical analysis of financial market data. [GitHub](https://github.com/TA-Lib/ta-lib) ⭐ 1,655 | 🐛 15 | 🌐 Java | 📅 2026-08-13
  * [ta-lib-python](https://github.com/TA-Lib/ta-lib-python) ⭐ 12,184 | 🐛 137 | 🌐 Cython | 📅 2026-07-29
  * [ta-lib](https://github.com/TA-Lib/ta-lib) ⭐ 1,655 | 🐛 15 | 🌐 Java | 📅 2026-08-13
* [XAD](https://github.com/auto-differentiation/xad) ⭐ 426 | 🐛 8 | 🌐 C++ | 📅 2026-07-05 - Automatic Differentation (AAD) Library.
* [godzilla.dev](https://godzilla.dev) - `C++` `Python` - Open-source framework for crypto quant trading, funding rate arbitrage and ultra-low-latency market making. [GitHub](https://github.com/godzilla-foundation/godzilla-community) ⭐ 368 | 🐛 2 | 🌐 C++ | 📅 2026-08-11
* [RunMat](https://runmat.org) - High performance, Open Source, MATLAB syntax runtime. [GitHub](https://github.com/runmat-org/runmat) ⭐ 248 | 🐛 29 | 🌐 Rust | 📅 2026-08-13
* [RunMat](https://github.com/runmat-org/runmat) ⭐ 248 | 🐛 29 | 🌐 Rust | 📅 2026-08-13 - Rust runtime for MATLAB-syntax array math with automatic CPU/GPU execution and fused kernels for quant simulations.
...
* [python-training](https://github.com/jpmorganchase/python-training) ⭐ 13,910 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-07-17 - J.P. Morgan's Python training for business analysts and traders.
* [Finance](https://github.com/shashankvemuri/Finance) ⭐ 4,158 | 🐛 22 | 🌐 Python | 📅 2026-03-26 - 150+ quantitative finance Python programs to help you gather, manipulate, and analyze stock market data.
...
* [py4fi2nd](https://github.com/yhilpisch/py4fi2nd) ⭐ 2,254 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2025-06-06 - Jupyter Notebooks and code for Python for Finance (2nd ed., O'Reilly) by Yves Hilpisch.
...
* [Stock\_Analysis\_For\_Quant](https://github.com/LastAncientOne/Stock_Analysis_For_Quant) ⭐ 2,044 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2025-05-04 - Different Types of Stock Analysis in Excel, Matlab, Power BI, Python, R, and Tableau.
* [volatility-trading](https://github.com/jasonstrimpel/volatility-trading) ⭐ 1,941 | 🐛 4 | 🌐 Python | 📅 2024-10-21 - A complete set of volatility estimators based on Euan Sinclair's Volatility Trading.
...
* [Deep Learning Machine Learning Stock](https://github.com/LastAncientOne/Deep-Learning-Machine-Learning-Stock) ⭐ 1,781 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2024-03-01 - Deep Learning and Machine Learning stocks represent a promising long-term or short-term opportunity for investors and traders.
...
* [fecon235](https://github.com/rsvp/fecon235) ⭐ 1,273 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2023-01-20 - Open source project for software tools in financial economics. Many jupyter notebook to verify theoretical ideas and practical methods interactively.
* [QuantFinanceBook](https://github.com/LechGrzelak/QuantFinanceBook) ⭐ 943 | 🐛 3 | 🌐 Python | 📅 2025-04-14 - Quantitative Finance book.
* [Computational-Finance-Course](https://github.com/LechGrzelak/Computational-Finance-Course) ⭐ 858 | 🐛 0 | 🌐 Python | 📅 2024-03-01 - Materials for the course of Computational Finance.
...
* [py4at](https://github.com/yhilpisch/py4at) ⭐ 848 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2023-10-09 - Jupyter Notebooks and code for the book Python for Algorithmic Trading (O'Reilly) by Yves Hilpisch.
...
* [Machine-Learning-for-Asset-Managers](https://github.com/emoen/Machine-Learning-for-Asset-Managers) ⭐ 657 | 🐛 2 | 🌐 Python | 📅 2026-02-11 - Implementation of code snippets, exercises and application to live data from Machine Learning for Asset Managers (Elements in Quantitative Finance) written by Prof. Marcos López de Prado.
* [dawp](https://github.com/yhilpisch/dawp) ⭐ 641 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-02-22 - Jupyter Notebooks and code for Derivatives Analytics with Python (Wiley Finance) by Yves Hilpisch.
* [QuantFinance](https://github.com/PythonCharmers/QuantFinance) ⭐ 615 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2025-09-02 - Training materials in quantitative finance.
...
* [quant](https://github.com/paulperry/quant) ⭐ 445 | 🐛 0 | 🌐 Python | 📅 2015-07-14 - Quantitative Finance and Algorithmic Trading exhaust; mostly ipython notebooks based on Quantopian, Zipline, or Pandas.
...
* [Differential Machine Learning and Axes that matter by Brian Huge and Antoine Savine](https://github.com/differential-machine-learning/notebooks) ⭐ 148 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-10-05 - Implement, demonstrate, reproduce and extend the results of the Risk articles 'Differential Machine Learning' (2020) and 'PCA with a Difference' (2021) by Huge and Savine, and cover implementation details left out from the papers.
...
* [101\_formulaic\_alphas](https://github.com/ram-ki/101_formulaic_alphas) ⭐ 51 | 🐛 0 | 🌐 Python | 📅 2022-07-11 - Implementation of [101 formulaic alphas](https://arxiv.org/ftp/arxiv/papers/1601/1601.00991.pdf) using qstrader.
* [QuantFinanceTraining](https://github.com/JoaoJungblut/QuantFinanceTraining) ⭐ 43 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-02-20 - This repository contains codes that were executed during my training in the CQF (Certificate in Quantitative Finance). The codes are organized by class, facilitating navigation and reference.
...
* [The Stall](https://the-stall.intuitek.ai) - `JavaScript` - 277 pay-per-call tools via MCP: US stocks, crypto, DeFi analytics, Polymarket prediction markets, macro data, and sanctions screening. USDC on Base. No API key required. [GitHub](https://github.com/thebrierfox/the-stall) ⭐ 6 | 🐛 1 | 🌐 JavaScript | 📅 2026-07-29
