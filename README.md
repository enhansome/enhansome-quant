...
* [pandas](https://pandas.pydata.org) - `Python` - pandas is an open source, BSD-licensed library providing high-performance, easy-to-use data structures and data analysis tools for the Python programming language. [GitHub](https://github.com/pandas-dev/pandas) ⭐ 49,628 | 🐛 2,715 | 🌐 Python | 📅 2026-09-03
* [polars](https://docs.pola.rs/) - `Python` - Polars is a blazingly fast DataFrame library for manipulating structured data. [GitHub](https://github.com/pola-rs/polars) ⭐ 39,622 | 🐛 2,882 | 🌐 Rust | 📅 2026-09-03
* [numpy](https://www.numpy.org) - `Python` - NumPy is the fundamental package for scientific computing with Python. [GitHub](https://github.com/numpy/numpy) ⭐ 32,645 | 🐛 2,337 | 🌐 Python | 📅 2026-09-03
* [scipy](https://www.scipy.org) - `Python` - SciPy (pronounced “Sigh Pie”) is a Python-based ecosystem of open-source software for mathematics, science, and engineering. [GitHub](https://github.com/scipy/scipy) ⭐ 14,985 | 🐛 1,823 | 🌐 Python | 📅 2026-09-03
* [sympy](https://www.sympy.org/) - `Python` - SymPy is a Python library for symbolic mathematics. [GitHub](https://github.com/sympy/sympy) ⭐ 14,905 | 🐛 5,966 | 🌐 Python | 📅 2026-09-02
* [pymc3](https://docs.pymc.io/) - `Python` - Probabilistic Programming in Python: Bayesian Modeling and Probabilistic Machine Learning with Theano. [GitHub](https://github.com/pymc-devs/pymc) ⭐ 9,735 | 🐛 491 | 🌐 Python | 📅 2026-08-31
* [data.table](https://github.com/Rdatatable/data.table) ⭐ 3,915 | 🐛 983 | 🌐 R | 📅 2026-08-31 - `R` - Extension of data.frame: Fast aggregation of large data (e.g. 100GB in RAM), fast ordered joins, fast add/modify/delete of columns by group using no copies at all, list columns and a fast file reader (fread). Offers a natural and flexible syntax, for faster development.
* [ArcticDB](https://github.com/man-group/ArcticDB) ⭐ 2,506 | 🐛 336 | 🌐 C++ | 📅 2026-09-03 - `Python` - High performance datastore for time series and tick data.
...
* [modelx](https://docs.modelx.io/) - `Python` - Python reimagination of spreadsheets as formula-centric objects that are interoperable with pandas. [GitHub](https://github.com/fumitoh/modelx) ⭐ 134 | 🐛 37 | 🌐 Python | 📅 2026-08-31
* [jacobian](https://github.com/morluto/jacobian) ⭐ 125 | 🐛 156 | 🌐 Python | 📅 2026-09-03 - `Python` `MCP` - Exact computation and conjecture testing across polynomial maps, linear algebra, and graph algorithms for agent-driven mathematical research.
...
* [gs-quant](https://github.com/goldmansachs/gs-quant) ⭐ 12,869 | 🐛 70 | 🌐 Python | 📅 2026-09-01 - `Python` - Python toolkit for quantitative finance.
...
* [FinancePy](https://github.com/domokane/FinancePy) ⭐ 3,126 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2026-09-02 - `Python` - A Python Finance Library that focuses on the pricing and risk-management of Financial Derivatives, including fixed-income, equity, FX and credit derivatives.
* [ffn](https://github.com/pmorissette/ffn) ⭐ 2,638 | 🐛 7 | 🌐 Python | 📅 2026-09-01 - `Python` - A financial function library for Python.
* [RustQuant](https://github.com/avhz/RustQuant) ⭐ 1,816 | 🐛 34 | 🌐 Rust | 📅 2026-01-14 - `Rust` - Quantitative finance library written in Rust.
...
* [QuantPy](https://github.com/jsmidt/QuantPy) ⭐ 1,054 | 🐛 17 | 🌐 Python | 📅 2023-05-25 - `Python` - A framework for quantitative finance In python.
...
* [Strata](http://strata.opengamma.io/) - `Java` - Modern open-source analytics and market risk library designed and written in Java. [GitHub](https://github.com/OpenGamma/Strata) ⭐ 960 | 🐛 91 | 🌐 Java | 📅 2026-08-25
...
* [TA-Lib](https://github.com/mrjbq7/ta-lib) ⭐ 12,230 | 🐛 137 | 🌐 Cython | 📅 2026-08-29 - `Python` - Python wrapper for TA-Lib (<http://ta-lib.org/>).
...
* [ta4j](https://github.com/ta4j/ta4j) ⭐ 2,486 | 🐛 18 | 🌐 Java | 📅 2026-09-03 - `Java` - A Java library for technical analysis.
...
* [IndicatorGo](https://github.com/cinar/indicator) ⭐ 1,663 | 🐛 40 | 🌐 Go | 📅 2026-09-03 - `Golang` - IndicatorGo is a Golang module providing various stock technical analysis indicators, strategies, and a backtest framework for trading.
...
* [IndicatorTS](https://github.com/cinar/indicatorts) ⭐ 469 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-03 - `JavaScript` - Indicator is a TypeScript module providing various stock technical analysis indicators, strategies, and a backtest framework for trading.
...
* [freqtrade](https://github.com/freqtrade/freqtrade) ⭐ 53,975 | 🐛 31 | 🌐 Python | 📅 2026-09-03 - `Python` - Free, open source crypto trading bot.

* [Qlib](https://github.com/microsoft/qlib) ⭐ 48,228 | 🐛 474 | 🌐 Python | 📅 2026-09-02 - `Python` - An AI-oriented Quantitative Investment Platform by Microsoft. Full ML pipeline of data processing, model training, back-testing; and covers the entire chain of quantitative investment: alpha seeking, risk modeling, portfolio optimization, and order execution.

* [vnpy](https://github.com/vnpy/vnpy) ⭐ 45,079 | 🐛 33 | 🌐 Python | 📅 2026-09-01 - `Python` - VeighNa is a Python-based open source quantitative trading system development framework.

* [ccxt](https://github.com/ccxt/ccxt) ⭐ 43,846 | 🐛 845 | 🌐 Python | 📅 2026-09-03 - `JavaScript` `Python` `PHP` - A JavaScript / Python / PHP cryptocurrency trading API with support for more than 100 bitcoin/altcoin exchanges.

* [Vibe-Trading](https://github.com/HKUDS/Vibe-Trading) ⭐ 32,358 | 🐛 44 | 🌐 Python | 📅 2026-09-02 - `Python` - Natural-language multi-agent finance research agent with 29 swarm presets, 70 skills, and 28 auto-discovered tools; 7 backtest engines covering A-shares/US/Crypto/Futures/Forex/Options plus a cross-market CompositeEngine with shared capital pool; 5-source auto-fallback data layer (tushare/okx/yfinance/akshare/ccxt); 17-tool MCP server; includes trade-journal behavioral diagnostics for 同花顺/东财/富途 exports.

* [nautilus\_trader](https://github.com/nautechsystems/nautilus_trader) ⭐ 28,336 | 🐛 130 | 🌐 Rust | 📅 2026-09-03 - `Python` `Rust` - A high-performance algorithmic trading platform and event-driven backtester.

* [backtrader](https://github.com/backtrader/backtrader) ⭐ 23,127 | 🐛 63 | 🌐 Python | 📅 2024-08-19 - `Python` - Python Backtesting library for trading strategies.

* [Lean](https://github.com/QuantConnect/Lean) ⭐ 21,467 | 🐛 259 | 🌐 C# | 📅 2026-09-02 - `Python` `C#` - Lean Algorithmic Trading Engine by QuantConnect (Python, C#).

* [QuantConnect](https://github.com/QuantConnect/Lean) ⭐ 21,467 | 🐛 259 | 🌐 C# | 📅 2026-09-02 - `CSharp` - Lean Engine is an open-source fully managed C# algorithmic trading engine built for desktop and cloud usage.

* [machine-learning-for-trading](https://github.com/stefan-jansen/machine-learning-for-trading) ⭐ 20,770 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-03 - `Python` - Code and resources for Machine Learning for Algorithmic Trading.

* [zipline](https://github.com/quantopian/zipline) ⭐ 20,079 | 🐛 370 | 🌐 Python | 📅 2024-02-13 - `Python` - Pythonic algorithmic trading library.

* [FinRL-Library](https://github.com/AI4Finance-LLC/FinRL-Library) ⭐ 16,203 | 🐛 310 | 🌐 Jupyter Notebook | 📅 2026-07-13 - `Python` - A Deep Reinforcement Learning Library for Automated Trading in Quantitative Finance. NeurIPS 2020.

* [QUANTAXIS](https://github.com/yutiansut/quantaxis) ⭐ 11,084 | 🐛 239 | 🌐 Python | 📅 2026-09-01 - `Matlab` - Integrated Quantitative Toolbox with Matlab.

* [StockSharp](https://github.com/StockSharp/StockSharp) ⭐ 10,689 | 🐛 2 | 🌐 C# | 📅 2026-09-01 - `CSharp` - Algorithmic trading and quantitative trading open source platform to develop trading robots (stock markets, forex, crypto, bitcoins, and options).
...
* [vectorbt](https://github.com/polakowo/vectorbt) ⭐ 8,973 | 🐛 140 | 🌐 Python | 📅 2026-08-02 - `Python` - Find your trading edge, using a powerful toolkit for backtesting, algorithmic trading, and research.

* [jesse](https://github.com/jesse-ai/jesse) ⭐ 8,411 | 🐛 16 | 🌐 Python | 📅 2026-09-02 - `Python` - An advanced crypto trading bot written in Python.

* [quantstats](https://github.com/ranaroussi/quantstats) ⭐ 7,610 | 🐛 31 | 🌐 Python | 📅 2026-07-20 - `Python` - Portfolio analytics for quants, written in Python.

* [rqalpha](https://github.com/ricequant/rqalpha) ⭐ 6,743 | 🐛 31 | 🌐 Python | 📅 2026-09-02 - `Python` - A extendable, replaceable Python algorithmic backtest && trading framework supporting multiple securities.

* [OctoBot](https://github.com/Drakkar-Software/OctoBot) ⭐ 6,507 | 🐛 167 | 🌐 Python | 📅 2026-09-02 - `Python` - Open source cryptocurrency trading bot for high frequency, arbitrage, TA and social trading with an advanced web interface.

* [pyalgotrade](https://github.com/gbeced/pyalgotrade) ⚠️ Archived - `Python` - Python Algorithmic Trading Library.

* [hftbacktest](https://github.com/nkaz001/hftbacktest) ⭐ 4,590 | 🐛 15 | 🌐 Rust | 📅 2025-12-23 - `Python` - A high-frequency trading and market-making backtesting tool accounts for limit orders, queue positions, and latencies, utilizing full tick data for trades and order books.
...
* [PyBroker](https://github.com/edtechre/pybroker) ⭐ 3,523 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - `Python` - Algorithmic Trading with Machine Learning.

* [pysystemtrade](https://github.com/robcarver17/pysystemtrade) ⭐ 3,496 | 🐛 31 | 🌐 Python | 📅 2026-07-18 - `Python` - pysystemtrade is the open source version of Robert Carver's backtesting and trading engine that implements systems according to the framework outlined in his book "Systematic Trading", which is further developed on his [blog](https://qoppac.blogspot.com/).

* [Hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,486 | 🐛 5 | 🌐 C++ | 📅 2026-09-02 - `Python` `C++` - A base on Python/C++ open source high-performance quant framework for faster analysis and backtesting, contains the complete trading system components for reuse and combination.

* [Hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,486 | 🐛 5 | 🌐 C++ | 📅 2026-09-02 - `Python` `C++` - A base on Python/C++ open source high-performance quant framework for faster analysis and backtesting, contains the complete trading system components for reuse and combination. You can use python or c++ freely.
...
* [QSTrader](https://github.com/mhallsmoore/qstrader) ⭐ 3,455 | 🐛 18 | 🌐 Python | 📅 2024-06-30 - `Python` - QSTrader backtesting simulation engine.
...
* [Barter](https://github.com/barter-rs/barter-rs) ⭐ 2,252 | 🐛 89 | 🌐 Rust | 📅 2026-08-24 - `Rust` - Open-source Rust framework for building event-driven live-trading & backtesting systems.

* [Investing algorithm framework](https://github.com/coding-kitties/investing-algorithm-framework) ⭐ 2,041 | 🐛 74 | 🌐 Python | 📅 2026-09-03 - `Python` - Framework for developing, backtesting, and deploying automated trading algorithms.

* [Lumibot](https://github.com/Lumiwealth/lumibot) ⭐ 2,038 | 🐛 87 | 🌐 Python | 📅 2026-09-03 - `Python` - Algorithmic trading framework where the same code runs for backtesting and live trading across stocks, options, crypto, futures, and forex with multiple brokers including Alpaca, Interactive Brokers, Tradier, and Schwab.

* [zipline-reloaded](https://github.com/stefan-jansen/zipline-reloaded) ⭐ 1,932 | 🐛 44 | 🌐 Python | 📅 2026-01-06 - `Python` - Zipline, a Pythonic Algorithmic Trading Library.

* [Intelligent Trading Bot](https://github.com/asavinov/intelligent-trading-bot) ⭐ 1,869 | 🐛 47 | 🌐 Python | 📅 2026-08-30 - `Python` - Automatically generating signals and trading based on machine learning and feature engineering.
...
* [qf-lib](https://github.com/quarkfin/qf-lib) ⭐ 959 | 🐛 13 | 🌐 Python | 📅 2026-08-31 - `Python` - QF-Lib is a Python library that provides high quality tools for quantitative finance.
...
* [PRISM-INSIGHT](https://github.com/dragon1086/prism-insight) ⭐ 734 | 🐛 6 | 🌐 Python | 📅 2026-09-03 - `Python` - AI-powered stock analysis system with 13 specialized agents, automated trading via KIS API, supporting Korean & US markets.
...
* [backtrader (cloudQuant fork)](https://github.com/cloudQuant/backtrader) ⭐ 160 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - `Python` - Actively maintained, high-performance backtesting and live trading framework with AI-assisted strategy tooling (MCP server, skills, agent, web platform). [backtrader](https://github.com/backtrader/backtrader) ⭐ 23,127 | 🐛 63 | 🌐 Python | 📅 2024-08-19 fork.
...
* [OctoBot Script](https://github.com/Drakkar-Software/OctoBot-Script) ⭐ 47 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-02 - `Python` - A quant framework to create cryptocurrencies strategies - from backtesting to optimization to livetrading.
...
* [TraderHarness](https://github.com/HephaestLab/TraderHarness) ⭐ 33 | 🐛 1 | 🌐 Python | 📅 2026-08-22 - `Python` - Contamination-resistant A-share backtesting environment for LLM trading agents with point-in-time masking, entity/date anonymization, fingerprinted replay, and trajectory (SFT) export.

* [purgedcv](https://github.com/eslazarev/purged-cross-validation) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2026-08-30 - `Python` - scikit-learn-compatible purged, group-purged, and combinatorial purged (CPCV) cross-validation, walk-forward splitting, and backtest-overfitting statistics (deflated and probabilistic Sharpe ratios, PBO, minimum backtest length) to prevent leakage and overfitting when backtesting trading strategies.
...
* [Manifold-BT](https://github.com/manifoldbt/manifoldbt) ⭐ 29 | 🐛 3 | 🌐 Python | 📅 2026-09-02 - `Python` `Rust` - High-performance Rust-powered backtesting engine for quantitative research with parameter sweeps, walk-forward and Monte Carlo.
...
* [DepthSight](https://github.com/depthsight-pro/depthsight) ⭐ 20 | 🐛 6 | 🌐 Python | 📅 2026-09-02 - `Python` `TypeScript` - Self-hosted visual algo-trading platform featuring a drag-and-drop strategy builder, an AI co-pilot, and integrated billing.
...
* [AlgoVault](https://github.com/AlgoVaultLabs/crypto-quant-signal-mcp) ⭐ 7 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-03 - `TypeScript` - MCP server returning composite crypto trade verdicts (direction, confidence, regime) across 5 perpetual-futures venues, with cross-venue funding-rate arbitrage and an on-chain Merkle-verified track record. Free tier.
...
* [falsification-ledger](https://github.com/foolproof-labs/falsification-ledger) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - `Python` - Hash-chained pre-registration and falsification ledger for research claims: write down what evidence would kill your claim before seeing the data; append-only JSONL with a sha256 chain (`fl verify` detects any edit), Wilson-CI hit-rate vs the random baseline, fail-closed falsification report contracts. [PyPI](https://pypi.org/project/falsification-ledger/)
...
* [Ghostfolio](https://github.com/ghostfolio/ghostfolio) ⭐ 9,233 | 🐛 307 | 🌐 TypeScript | 📅 2026-09-02 - `JavaScript` - Wealth management software to keep track of financial assets like stocks, ETFs or cryptocurrencies and make solid, data-driven investment decisions.
* [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,411 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 - `Python` - Portfolio and risk analytics in Python.
* [PyPortfolioOpt](https://github.com/robertmartin8/PyPortfolioOpt) ⭐ 6,005 | 🐛 114 | 🌐 Jupyter Notebook | 📅 2026-07-07 - `Python` - Financial portfolio optimization in python, including classical efficient frontier and advanced methods.
* [mlfinlab](https://github.com/hudson-and-thames/mlfinlab) ⭐ 4,917 | 🐛 49 | 🌐 Python | 📅 2023-10-02 - `Python` - Implementations regarding "Advances in Financial Machine Learning" by Marcos Lopez de Prado. (Feature Engineering, Financial Data Structures, Meta-Labeling).
...
* [Eiten](https://github.com/tradytics/eiten) ⭐ 3,292 | 🐛 18 | 🌐 Python | 📅 2022-07-30 - `Python` - Eiten is an open source toolkit by Tradytics that implements various statistical and algorithmic investing strategies such as Eigen Portfolios, Minimum Variance Portfolios, Maximum Sharpe Ratio Portfolios, and Genetic Algorithms based Portfolios.
* [skfolio](https://github.com/skfolio/skfolio) ⭐ 2,337 | 🐛 40 | 🌐 Python | 📅 2026-08-31 - `Python` - Python library for portfolio optimization built on top of scikit-learn. It provides a unified interface and sklearn compatible tools to build, tune and cross-validate portfolio models.
...
* [Empyrial](https://github.com/ssantoshp/Empyrial) ⭐ 1,082 | 🐛 6 | 🌐 Python | 📅 2025-09-14 - `Python` - Portfolio's risk and performance analytics and returns predictions.
...
* [pyfolio-reloaded](https://github.com/stefan-jansen/pyfolio-reloaded) ⭐ 612 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2025-12-15 - `Python` - Portfolio and risk analytics in Python. [pyfolio](https://github.com/quantopian/pyfolio) ⭐ 6,411 | 🐛 166 | 🌐 Jupyter Notebook | 📅 2023-12-23 fork.
...
* [alphalens](https://github.com/quantopian/alphalens) ⭐ 4,436 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2024-02-12 - `Python` - Performance analysis of predictive alpha factors.
...
* [Facebook Prophet](https://github.com/facebook/prophet) ⭐ 20,383 | 🐛 452 | 🌐 Python | 📅 2026-08-27 - `Python` - Tool for producing high quality forecasts for time series data that has multiple seasonality with linear or non-linear growth.
...
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,304 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-07-06 - `Python` - Automatic extraction of relevant features from time series.
* [gluon-ts](https://github.com/awslabs/gluon-ts) ⭐ 5,230 | 🐛 479 | 🌐 Python | 📅 2026-07-31 - `Python` - vProbabilistic time series modeling in Python.
...
* [PineForge](https://github.com/pineforge-4pass/pineforge-engine) ⭐ 181 | 🐛 2 | 🌐 C++ | 📅 2026-09-03 - `C++` - Deterministic offline PineScript v6 → C++ backtest runtime, validated trade-for-trade against TradingView (245/246 strict, 0 engine bugs). Runs locally via Docker and is drivable by AI agents through a bundled MCP server.
...
* [OpenBB Terminal](https://github.com/OpenBB-finance/OpenBBTerminal) ⭐ 72,638 | 🐛 112 | 🌐 Python | 📅 2026-07-30 - `Python` - Terminal for investment research for everyone.
* [Fincept Terminal](https://github.com/Fincept-Corporation/FinceptTerminal) ⭐ 30,916 | 🐛 1 | 🌐 C++ | 📅 2026-09-01 - `Python` - Advance Data Based A.I Terminal for all Types of Financial Asset Research.
* [yfinance](https://github.com/ranaroussi/yfinance) ⭐ 25,157 | 🐛 104 | 🌐 Python | 📅 2026-08-27 - `Python` - Yahoo! Finance market data downloader (+faster Pandas Datareader).
* [akshare](https://github.com/jindaxiang/akshare) ⭐ 22,388 | 🐛 5 | 🌐 Python | 📅 2026-09-02 - `Python` - AkShare is an elegant and simple financial data interface library for Python, built for human beings! <https://akshare.readthedocs.io>.
...
* [FinanceToolkit](https://github.com/JerBouma/FinanceToolkit) ⭐ 5,285 | 🐛 6 | 🌐 Python | 📅 2026-09-01 - `Python` - Toolkit with 200+ financial metrics including 80+ financial ratios, 30+ technical indicators, 20+ risk and performance metrics and 50+ macro indicators which pulls from Financial Modeling Prep, Yahoo Finance, OECD, GMBD and more.
...
* [edgartools](https://github.com/dgunning/edgartools) ⭐ 2,647 | 🐛 53 | 🌐 Python | 📅 2026-09-03 - `Python` - AI-native SEC EDGAR library with XBRL financials, clean text extraction, 17+ typed forms, and pandas DataFrames.
* [findatapy](https://github.com/cuemacro/findatapy) ⭐ 2,112 | 🐛 28 | 🌐 Python | 📅 2026-07-02 - `Python` - Python library to download market data via Bloomberg, Quandl, Yahoo etc.
...
* [yahoo-finance](https://github.com/lukaszbanasiak/yahoo-finance) ⭐ 1,446 | 🐛 88 | 🌐 Python | 📅 2023-12-25 - `Python` - Python module to get stock data from Yahoo! Finance.
...
* [Trading Strategy](https://github.com/tradingstrategy-ai/trading-strategy/) ⭐ 378 | 🐛 11 | 🌐 Python | 📅 2026-09-01 - `Python` - download price data for decentralised exchanges and lending protocols (DeFi).
...
* [Horus Flow](https://github.com/horustechltd/horus-flow-mcp) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-03 - `Python` - Sub-second L2 orderflow intelligence MCP server for institutional-grade market microstructure analysis.
...
* [FillBench](https://fillbench.com) - Reproducible crypto exchange REST API latency benchmarks (p50/p95/p99 and TLS connect time) measured every 2 hours from a fixed US East server. Raw data: [GitHub](https://github.com/sircharli3/fillbench-data) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-03.
...
* [pmxt](https://github.com/pmxt-dev/pmxt) ⭐ 2,114 | 🐛 1,214 | 🌐 TypeScript | 📅 2026-07-18 - `Python` `JavaScript` - The CCXT for prediction markets. A unified API for trading on Polymarket, Kalshi, and more.
...
* [D-Tale](https://github.com/man-group/dtale) ⭐ 5,217 | 🐛 71 | 🌐 TypeScript | 📅 2026-07-24 - `Python` - Visualizer for pandas dataframes and xarray datasets.
...
* [market-analy](https://github.com/maread99/market_analy) ⭐ 80 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - `Python` - Analysis and interactive charting using [market-prices](https://github.com/maread99/market_prices) ⭐ 105 | 🐛 10 | 🌐 Python | 📅 2026-08-14 and bqplot.
...
* [xlwings](https://www.xlwings.org/) - `Python` - Make Excel fly with Python. [GitHub](https://github.com/xlwings/xlwings) ⭐ 3,401 | 🐛 406 | 🌐 Python | 📅 2026-09-01
...
* [dsh-quant](https://github.com/pengpengyi92/dsh-quant) ⭐ 29 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-01 - `TypeScript` `DeepSeek Harness` - Agent-native quantitative research toolkit for DeepSeek Harness: 46 tools across data, alpha, ML, risk, execution and ecosystem domains, with an end-to-end research pipeline.
...
* [TA-Lib](https://ta-lib.org) - perform technical analysis of financial market data. [GitHub](https://github.com/TA-Lib/ta-lib) ⭐ 1,663 | 🐛 13 | 🌐 Java | 📅 2026-09-03
  * [ta-lib-python](https://github.com/TA-Lib/ta-lib-python) ⭐ 12,230 | 🐛 137 | 🌐 Cython | 📅 2026-08-29
  * [ta-lib](https://github.com/TA-Lib/ta-lib) ⭐ 1,663 | 🐛 13 | 🌐 Java | 📅 2026-09-03
* [PineTS](https://github.com/LuxAlgo/PineTS) ⭐ 521 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-01 - `TypeScript` `JavaScript` `Pine Script` - Open-source transpiler and runtime that executes Pine Script logic in Node.js and the browser with 1:1 syntax compatibility, for running indicators and strategies on your own infrastructure.
...
* [python-training](https://github.com/jpmorganchase/python-training) ⭐ 14,064 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-24 - J.P. Morgan's Python training for business analysts and traders.
...
* [AFML](https://github.com/boyboi86/AFML) ⭐ 867 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2024-09-05 - All the answers for exercises from Advances in Financial Machine Learning by Dr Marco Lopez de Parodo.
* [py4at](https://github.com/yhilpisch/py4at) ⭐ 852 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2023-10-09 - Jupyter Notebooks and code for the book Python for Algorithmic Trading (O'Reilly) by Yves Hilpisch.
...
* [AtlasYield](https://atlasyield.club) - Independent rating and allocation layer for on-chain yield: scores every DeFi vault 0-100 across 16 factors, with a public read-only scores API. [GitHub](https://github.com/gveshk/atlasyield-score-history) ⭐ 0 | 🐛 0 | 📅 2026-09-03
...
* [awesome-sec-filings](https://github.com/vibeyclaw/awesome-sec-filings) ⭐ 41 | 🐛 8 | 📅 2026-07-04 - A curated list of tools, data sources, libraries, and resources for working with SEC filings (13F, 10-K, 10-Q, 8-K).
